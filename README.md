...
**Monnit / Libelium (competidores indirectos IoT)**
...
| **EP05** | Administración, soberanía y extensibilidad open source | Como administrador o desarrollador, quiero gestionar la infraestructura y escalar el sistema mediante código abierto, exportando datos e integrando plugins externos. | **Escenario 1:** Exportación total de datos en formatos abiertos (.csv, .json) para respaldo. <br>**Escenario 2:** Integración de plugins externos mediante API para nuevas funcionalidades. <br>**Escenario 3:** Logs de auditoría de sistema para rastrear cambios en la configuración base. |
...
| :--- | :--- | :--- | :--- | :--- |
| **US-01** | Registro y autenticación de usuarios | Como gestor operativo, quiero crear una cuenta e iniciar sesión en la plataforma para acceder a los módulos de gestión de mi obra asignada. | **Escenario 1:** <br>Dado que el usuario accede por primera vez a Kipu, <br>Cuando completa el formulario de registro con sus datos profesionales y rol, <br>Entonces el sistema crea la cuenta, asigna permisos según el rol y redirige al dashboard principal. <br><br>**Escenario 2:** <br>Dado que el usuario ya tiene una cuenta registrada, <br>Cuando ingresa sus credenciales válidas en el formulario de login, <br>Entonces el sistema autentica al usuario y lo redirige a su vista correspondiente según su rol. | **EP01** |
| **US-02** | Registro de Resultado No Conforme (RNC) | Como supervisor de obra, quiero registrar un RNC con evidencia fotográfica para que el equipo de diseño sea alertado y subsane el error de inmediato. | **Escenario 1:** <br>Dado que el supervisor detecta una falla técnica en la estructura durante la inspección, <br>Cuando completa el formulario de incidencia con descripción, ubicación y sube al menos una foto, <br>Entonces el sistema genera un ticket de alerta trazable y notifica al equipo de diseño. <br><br>**Escenario 2:** <br>Dado que el supervisor olvida adjuntar una foto obligatoria, <br>Cuando intenta enviar el formulario RNC, <br>Entonces el sistema bloquea el envío y muestra un mensaje solicitando evidencia fotográfica. | **EP02** |
| **US-03** | Visualización de KPIs (PPC) | Como gerente de proyecto, quiero visualizar el Porcentaje de Plan Completado semanal para medir la productividad real de la obra. | **Escenario 1:** <br>Dado que el equipo ha marcado las tareas del día como finalizadas, <br>Cuando el gerente accede al módulo de indicadores, <br>Entonces el sistema calcula automáticamente el PPC semanal y lo muestra en un gráfico. <br><br>**Escenario 2:** <br>Dado que el gerente necesita ver la evolución del PPC en el último mes, <br>Cuando selecciona un filtro de período en el dashboard de KPIs, <br>Entonces el sistema genera una tendencia semanal con los valores históricos del proyecto. | **EP02** |
| **US-04** | Solicitud formal de materiales | Como residente de obra, quiero enviar pedidos de insumos desde la app para evitar errores de comunicación por canales informales. | **Escenario 1:** <br>Dado que el residente requiere materiales para una partida específica, <br>Cuando completa el formulario de requerimiento técnico con cantidades y fechas, <br>Entonces el sistema genera un ticket de solicitud con código de seguimiento y lo envía al área de logística. <br><br>**Escenario 2:** <br>Dado que el residente necesita modificar una solicitud ya enviada que aún no ha sido procesada, <br>Cuando accede al historial de pedidos y edita los campos correspondientes, <br>Entonces el sistema actualiza el ticket y notifica el cambio al equipo de logística. | **EP03** |
| **US-05** | Alerta automática de stock crítico | Como encargado de almacén, quiero recibir notificaciones cuando el inventario sea bajo para evitar paralizar la construcción. | **Escenario 1:** <br>Dado que el encargado registra la salida de un material que llega a su límite mínimo, <br>Cuando el sistema procesa el despacho, <br>Entonces el indicador visual cambia a rojo y se emite una alerta push al encargado y al jefe de compras. <br><br>**Escenario 2:** <br>Dado que el stock de un material cae por debajo del mínimo crítico durante la noche, <br>Cuando el sistema ejecuta la verificación automática de inventario, <br>Entonces envía un email detallado con los productos críticos al equipo de logística. | **EP03** |
| **US-06** | Validación de compra vs presupuesto | Como jefe de compras, quiero que el sistema bloquee pedidos que excedan el presupuesto meta para evitar pérdidas de utilidad. | **Escenario 1:** <br>Dado que el jefe de compras intenta procesar un pedido que excede el monto asignado a la partida, <br>Cuando presiona el botón de confirmar compra, <br>Entonces el sistema muestra un mensaje de error y bloquea la transacción. <br><br>**Escenario 2:** <br>Dado que el pedido se encuentra dentro del presupuesto disponible, <br>Cuando el jefe de compras confirma la transacción, <br>Entonces el sistema aprueba la compra y descuenta el monto del presupuesto restante. | **EP03** |
| **US-07** | Visualización de planos por especialidad | Como técnico de obra, quiero filtrar los planos por especialidad para localizar el diseño vigente rápidamente en campo. | **Escenario 1:** <br>Dado que el técnico visualiza la lista de documentos técnicos del proyecto, <br>Cuando selecciona el filtro por especialidad (Sanitarias, Eléctricas, Estructuras), <br>Entonces la aplicación muestra únicamente los planos correspondientes a esa categoría. <br><br>**Escenario 2:** <br>Dado que el técnico aplica múltiples filtros simultáneamente (especialidad + versión vigente), <br>Cuando confirma la selección, <br>Entonces el sistema muestra solo los planos que cumplen todas las condiciones. | **EP04** |
| **US-08** | Historial de versiones de planos con notificaciones | Como arquitecto, quiero ver el registro de versiones de un plano y recibir notificaciones cuando se publique una nueva versión, para asegurar que el equipo no use diseños obsoletos. | **Escenario 1:** <br>Dado que el arquitecto consulta los detalles de un plano específico, <br>Cuando abre la sección de historial del archivo, <br>Entonces el sistema lista todas las versiones previas con su respectiva fecha, responsable y cambios realizados. <br><br>**Escenario 2:** <br>Dado que el arquitecto necesita restaurar una versión anterior del plano, <br>Cuando selecciona una versión previa y confirma la restauración, <br>Entonces el sistema actualiza el plano vigente, registra el cambio en el historial y envía una notificación push/email al equipo de obra. <br><br>**Escenario 3:** <br>Dado que un nuevo plano es subido al sistema, <br>Cuando se confirma la publicación, <br>Entonces el sistema envía una alerta automática (push/email) a todos los profesionales asignados al proyecto notificando la nueva versión disponible. | **EP04** |
| **US-09** | Firma digital de actas con token | Como ingeniero residente, quiero firmar actas de conformidad con un código de verificación para asegurar la validez legal del cierre de etapa. | **Escenario 1:** <br>Dado que el residente verifica que la partida cumple con los estándares del proyecto, <br>Cuando ingresa el código de verificación de 6 dígitos enviado a su celular, <br>Entonces el sistema sella digitalmente el documento PDF como aprobado y registra la transacción. <br><br>**Escenario 2:** <br>Dado que el residente ingresa un código de verificación incorrecto o expirado, <br>Cuando intenta validar la firma digital, <br>Entonces el sistema rechaza la operación, muestra un mensaje de error y no sella el documento. | **EP02** |
| **US-10** | Landing page - Visualización de propuesta de valor | Como visitante general del sitio web, quiero conocer la propuesta de valor y funcionalidades principales de Kipu para entender cómo puede ayudarme en mis proyectos de construcción. | **Escenario 1:** <br>Dado que un visitante accede al landing page de Kipu, <br>Cuando la página carga completamente, <br>Entonces el sitio muestra el título de la plataforma, una descripción breve de su propósito y un llamado a la acción principal ("Registrarse" o "Solicitar demo"). <br><br>**Escenario 2:** <br>Dado que el visitante desplaza la página hacia abajo, <br>Cuando llega a la sección de características, <br>Entonces visualiza al menos tres funcionalidades clave de Kipu (gestión de RNC, control de inventarios, KPIs) con íconos o imágenes representativas. | **EP01** |
...
| **US-13** | Atender solicitud de materiales | Como Encargado de Logística, quiero cambiar el estado de las solicitudes de materiales a "Aprobado" o "Rechazado", para mantener al equipo de obra informado sobre la disponibilidad de los insumos. | **Escenario 1:** <br>Dado que existe una solicitud de material en estado "Pendiente", <br>Cuando se selecciona la solicitud y se marca como "Aprobada", <br>Entonces el estado de la solicitud cambia a "En proceso de compra", y el Residente de Obra visualiza el cambio de estado en su panel. | **EP03** |
| **US-14** | Actualizar inventario general | Como Encargado de Logística, quiero actualizar las cantidades de los materiales en el almacén central, para mantener un registro exacto del stock físico disponible para las obras. | **Escenario 1:** <br>Dado que el módulo de inventario está accesible, <br>Cuando se ingresa una cantidad numérica positiva en el registro de un material existente, <br>Entonces el sistema suma el valor ingresado al stock actual, y registra la fecha y usuario responsable de la modificación. | **EP03** |
| **US-15** | Registrar avance diario de obra | Como Residente de Obra, quiero registrar el porcentaje de avance físico del proyecto diariamente, para mantener la trazabilidad de la ejecución real frente al cronograma. | **Escenario 1:** <br>Dado que el panel de control del proyecto está activo, <br>Cuando se ingresa un porcentaje de avance válido (1-100) y se adjunta una observación, <br>Entonces el sistema actualiza la barra de progreso general del proyecto, y guarda el registro en la bitácora histórica de la obra. | **EP02** |
| **US-16** | Cambiar estado del proyecto | Como Administrador del Sistema, quiero modificar el estado global de una obra (ej. En ejecución, Paralizada, Finalizada), para reflejar la situación operativa actual ante todos los usuarios. | **Escenario 1:** <br>Dado que un proyecto se encuentra en estado "En ejecución", <br>Cuando se selecciona el estado "Paralizada" y se confirma el cambio, <br>Entonces el sistema actualiza el distintivo visual del proyecto, y bloquea la creación de nuevos requerimientos de materiales para dicha obra. | **EP02** |
| **US-17** | Visualizar Dashboard logístico | Como Encargado de Logística, quiero visualizar un resumen gráfico de requerimientos pendientes y presupuesto ejecutado, para tomar decisiones de compra rápidas sin tener que cruzar datos de Excel. | **Escenario 1:** <br>Dado que el usuario inicia sesión con el rol de Logística, <br>Cuando se carga la vista principal (Dashboard), <br>Entonces el sistema renderiza un gráfico de anillos con las solicitudes pendientes, y muestra una tarjeta con el monto total de presupuesto ejecutado en el mes. | **EP02** |
| **US-18** | Asignar roles a usuarios | Como Administrador del Sistema, quiero asignar o modificar los permisos de los trabajadores en la plataforma, para asegurar que cada empleado solo tenga acceso a los módulos correspondientes a su cargo. | **Escenario 1:** <br>Dado que existe un usuario registrado con acceso básico, <br>Cuando se le asigna el rol "Encargado de Logística" desde el panel de administración, <br>Entonces el sistema habilita el acceso a los módulos de Inventario y Requerimientos para ese usuario en su próximo inicio de sesión. | **EP01** |
| **US-19** | Registro de Consulta Técnica (RFI) | Como Residente de Obra, quiero generar una RFI dirigida al proyectista para resolver dudas de diseño que impiden el avance de una partida. | **Escenario 1:** <br>Dado que hay una incompatibilidad en los planos, <br>Cuando el residente crea la RFI adjuntando el plano afectado y una pregunta técnica, <br>Entonces el sistema notifica al arquitecto y marca la consulta como "Abierta". <br><br>**Escenario 2:** <br>Dado que el arquitecto responde la consulta, <br>Cuando adjunta la solución técnica, <br>Entonces el sistema cierra el ticket, notifica al residente y vincula la respuesta al historial del plano. | **EP04** |
| **US-20** | Exportación de base de datos | Como Administrador, quiero exportar la información del proyecto en formatos abiertos (.csv, .json) para garantizar la soberanía de los datos. | **Escenario 1:** <br>Dado que la empresa requiere un backup externo, <br>Cuando el administrador selecciona "Exportar Proyecto", <br>Entonces el sistema genera un archivo comprimido con todas las tablas de presupuesto, logs y documentos. <br><br>**Escenario 2:** <br>Dado que el proyecto es Open Source, <br>Cuando un desarrollador utiliza la API de exportación, <br>Entonces el sistema entrega datos estructurados listos para ser migrados a otra instancia de Kipu. | **EP05** |
| **US-21** | Control de mermas y desperdicios | Como Encargado de Almacén, quiero registrar la merma de materiales para ajustar el stock real y analizar la eficiencia de los recursos. | **Escenario 1:** <br>Dado que se identifica material dañado en obra, <br>Cuando se registra la cantidad en el módulo de inventario con el motivo "Merma", <br>Entonces el sistema descuenta el stock y lo reporta como pérdida en el dashboard financiero. <br><br>**Escenario 2:** <br>Dado que la merma excede el margen permitido del 5%, <br>Cuando se procesa el registro, <br>Entonces el sistema emite una alerta naranja al Gerente de Proyecto. | **EP03** |
| **US-22** | Reporte fotográfico diario | Como Residente de Obra, quiero subir fotos diarias del frente de trabajo para generar una bitácora visual de sustento. | **Escenario 1:** <br>Dado que el residente finaliza la jornada, <br>Cuando sube fotos desde la app móvil etiquetándolas por partida (ej. Vaciado de losa), <br>Entonces el sistema las organiza cronológicamente en el álbum del proyecto. <br><br>**Escenario 2:** <br>Dado que se genera el reporte semanal, <br>Cuando el sistema compila la bitácora, <br>Entonces incluye automáticamente las fotos y observaciones registradas cada día en un PDF. | **EP02** |
| **US-23** | Gestión de subcontratistas | Como Gerente de Proyecto, quiero registrar el avance de subcontratistas para controlar sus pagos y cumplimiento de plazos. | **Escenario 1:** <br>Dado que un subcontratista entrega una etapa, <br>Cuando el gerente registra el porcentaje de avance correspondiente, <br>Entonces el sistema calcula el monto a pagar según el contrato registrado. <br><br>**Escenario 2:** <br>Dado que el subcontratista presenta un retraso, <br>Cuando el cronograma se actualiza, <br>Entonces el sistema resalta en rojo el contrato afectado por el incumplimiento de hitos. | **EP02** |
| **US-24** | Registro de incidentes (HSE) | Como Supervisor de Seguridad, quiero registrar incidentes o condiciones inseguras para cumplir con la normativa de seguridad en el trabajo. | **Escenario 1:** <br>Dado que se detecta una condición insegura en obra, <br>Cuando el supervisor registra la incidencia con foto y nivel de riesgo, <br>Entonces el sistema notifica al residente y genera una acción correctiva pendiente. <br><br>**Escenario 2:** <br>Dado que el incidente es reportado como "Grave", <br>Cuando se guarda el registro, <br>Entonces el sistema bloquea simbólicamente la partida afectada hasta que se registre la mitigación. | **EP06** |
| **US-25** | Acceso de visualización para Cliente | Como Cliente de la obra, quiero tener acceso de solo lectura para monitorear el avance físico y financiero de mi inversión. | **Escenario 1:** <br>Dado que el cliente inicia sesión con sus credenciales, <br>Cuando accede al Dashboard, <br>Entonces visualiza el porcentaje de avance y el registro fotográfico, sin permisos para editar costos o inventarios. <br><br>**Escenario 2:** <br>Dado que el proyecto tiene un retraso crítico, <br>Cuando el cliente consulta el cronograma, <br>Entonces visualiza la nueva fecha estimada de entrega calculada por el sistema. | **EP02** |
| **US-26** | Alerta de desviación presupuestal | Como Jefe de Oficina Técnica, quiero recibir notificaciones si el gasto real supera el presupuesto meta para tomar medidas correctivas. | **Escenario 1:** <br>Dado que se registra una compra que supera el precio unitario previsto, <br>Cuando se cierra la transacción, <br>Entonces el sistema calcula la desviación y envía una alerta de "Sobrecosto" al equipo administrativo. <br><br>**Escenario 2:** <br>Dado que la desviación es mayor al 10%, <br>Cuando el usuario consulta el presupuesto, <br>Entonces la celda de la partida se resalta en rojo con un desglose de la causa. | **EP02** |
| **US-27** | Préstamo de herramientas | Como Encargado de Almacén, quiero controlar el préstamo de equipos a las cuadrillas para evitar pérdidas y gestionar el mantenimiento. | **Escenario 1:** <br>Dado que un operario solicita una herramienta, <br>Cuando el almacenero registra la salida asignándola a un responsable, <br>Entonces el equipo figura como "En uso" en el inventario de activos. <br><br>**Escenario 2:** <br>Dado que la herramienta es devuelta, <br>Cuando el almacenero marca la recepción y el estado de entrega, <br>Entonces el sistema actualiza la disponibilidad y registra el historial de uso. | **EP03** |
| **US-28** | Activación de Plugins | Como Desarrollador, quiero habilitar módulos adicionales mediante la API de Kipu para extender las funciones básicas del sistema. | **Escenario 1:** <br>Dado que se ha desarrollado un plugin de integración (ej. pasarela de pagos), <br>Cuando el administrador sube el archivo del módulo, <br>Entonces el sistema valida la firma y añade la nueva opción en el menú de configuración. <br><br>**Escenario 2:** <br>Dado que un plugin genera errores de sistema, <br>Cuando el núcleo de Kipu detecta la falla, <br>Entonces desactiva automáticamente la extensión y genera un log de error. | **EP05** |
| **US-29** | Anotaciones digitales sobre planos | Como residente de obra, quiero realizar anotaciones digitales sobre el plano de cimentación, para reportar interferencias detectadas en campo inmediatamente al equipo de diseño. | **Escenario 1:** <br>Dado que el residente está visualizando un plano en la plataforma, <br>Cuando selecciona un área del plano y agrega una anotación con texto y opcionalmente una foto, <br>Entonces el sistema guarda la observación, la vincula a las coordenadas del plano y notifica al equipo de diseño. <br><br>**Escenario 2:** <br>Dado que el equipo de diseño recibe la notificación de una anotación, <br>Cuando accede al plano desde el enlace de la alerta, <br>Entonces visualiza la anotación y puede responder marcándola como "En revisión" o "Subsanada". | **EP04** |
| **US-30** | Generación de dossier de calidad | Como gerente de proyecto, quiero exportar un archivo PDF con todo el historial de firmas, RNCs y aprobaciones de una etapa, para facilitar la entrega del proyecto a la municipalidad o al cliente final. | **Escenario 1:** <br>Dado que el proyecto está en etapa de cierre o se requiere una auditoría, <br>Cuando el gerente accede al módulo de reportes y selecciona "Generar Dossier de Calidad", <br>Entonces el sistema compila todos los RNCs, actas firmadas, aprobaciones y reportes fotográficos en un único archivo PDF ordenado cronológicamente. <br><br>**Escenario 2:** <br>Dado que el dossier ha sido generado, <br>Cuando el usuario hace clic en descargar, <br>Entonces el sistema entrega el PDF con un código QR que permite verificar la autenticidad de los documentos contra la plataforma. | **EP04** |
| **US-31** | Registro de desperdicios y devoluciones | Como encargado de almacén, quiero registrar la cantidad de material dañado o sobrante por cada jornada, para ajustar las futuras compras y reducir el desperdicio acumulado. | **Escenario 1:** <br>Dado que se identifica material dañado o excedente en obra, <br>Cuando el encargado registra la cantidad en el módulo de inventario con el motivo "Merma" o "Devolución", <br>Entonces el sistema descuenta el stock, lo reporta en el dashboard financiero como pérdida y lo registra en el historial de desperdicios. <br><br>**Escenario 2:** <br>Dado que el porcentaje de desperdicio acumulado en el mes supera el umbral permitido (ej. 5%), <br>Cuando se procesa el registro, <br>Entonces el sistema emite una alerta al Gerente de Proyecto con un desglose de las causas más frecuentes. | **EP03** |
| **US-32** | Control de entrega de Equipo de seguridad al personal | Como supervisor de obras, quiero registrar la entrega de cascos y botas a cada trabajador para tener un respaldo ante auditorías laborales. | **Escenario 1:** <br>Dado que el supervisor entrega equipo nuevo (casco/botas), <br>Cuando selecciona al trabajador y el ítem en la app, <br>Entonces el sistema descuenta el stock del inventario y actualiza la ficha del empleado. <br><br>**Escenario 2:** <br>Dado que un arnés de seguridad ha llegado a su fecha de caducidad, <br>Cuando el sistema detecta el vencimiento, <br>Entonces notifica al supervisor para el cambio inmediato del equipo. | **EP06** |
| **US-33** | Dashboard de cumplimiento de las normas de Seguridad y Salud en el Trabajo | Como supervisor de obras, quiero ver un gráfico de barras con el número de incidentes vs. días sin accidentes para medir la seguridad de la empresa. | **Escenario 1:** <br>Dado que se registran incidencias diarias, <br>Cuando el supervisor consulta el dashboard de seguridad, <br>Entonces el sistema muestra el KPI actualizado de "Días sin Accidentes de Trabajo". <br><br>**Escenario 2:** <br>Dado que existen reportes previos, <br>Cuando el usuario accede al dashboard, <br>Entonces el sistema renderiza un gráfico de barras comparando el número de incidentes registrados versus la meta de seguridad del mes. | **EP06** |
| **US-34** | Bitácora fotográfica de excavaciones | Como supervisor de obras, quiero crear una galería específica para la etapa de excavación para documentar el tipo de suelo encontrado y evitar reclamos futuros. | **Escenario 1:** <br>Dado que se realiza una excavación, <br>Cuando el usuario sube fotos bajo la etiqueta "Suelo", <br>Entonces el sistema las organiza automáticamente en un álbum cronológico dentro de la etapa de excavación. <br><br>**Escenario 2:** <br>Dado que el cliente solicita evidencia del terreno, <br>Cuando el supervisor selecciona las fotos de la bitácora, <br>Entonces el sistema permite exportar un PDF con las imágenes, fechas y coordenadas del hallazgo. | **EP02** |
| **US-35** | Seguimiento de órdenes de cambio | Como arquitecto ayudante de logística, quiero registrar modificaciones al contrato original solicitadas por el cliente para ajustar el presupuesto y cronograma oficial. | **Escenario 1:** <br>Dado que el cliente solicita un cambio de diseño, <br>Cuando el arquitecto registra la "Orden de Cambio", <br>Entonces el sistema calcula automáticamente el impacto en el presupuesto total y lo muestra como un pendiente de aprobación. <br><br>**Escenario 2:** <br>Dado que la modificación implica más tiempo de ejecución, <br>Cuando se confirma la orden de cambio, <br>Entonces el sistema extiende las fechas de las tareas relacionadas en el cronograma oficial. | **EP01** |
| **US-36** | Control de herramientas asignadas | Como ayudante de logística, quiero registrar las herramientas eléctricas asignadas (taladros, amoladoras) a un obrero específico para que sea el responsable de su devolución en buen estado. | **Escenario 1:** <br>Dado que un operario solicita un taladro, <br>Cuando el ayudante de logística vincula el equipo al DNI del trabajador en la app, <br>Entonces el estado de la herramienta cambia a "En Uso por [Nombre]". <br><br>**Escenario 2:** <br>Dado que el operario devuelve la herramienta, <br>Cuando el ayudante registra el retorno, <br>Entonces el sistema permite marcar si el equipo regresó en "Buen estado" o "Con observaciones/daños". | **EP03** |
| **US-37** | Exportación de reporte de asistencia mensual | Como supervisor de obra, quiero exportar las asistencias del mes a un archivo CSV para facilitar el cálculo de la planilla en el software contable. | **Escenario 1:** <br>Dado que termina el periodo mensual, <br>Cuando el supervisor selecciona "Exportar Asistencias", <br>Entonces el sistema genera un archivo CSV compatible con software contable que contiene los días laborados por trabajador. <br><br>**Escenario 2:** <br>Dado que el supervisor gestiona varias obras, <br>Cuando aplica el filtro de "Proyecto A" antes de exportar, <br>Entonces el archivo descargado contiene únicamente el personal asignado a esa ubicación. | **EP04** |
| **US-38** | Visualización de planos en 3D | Como arquitecto ayudante de logística, quiero visualizar modelos 3D sencillos (formatos glTF/OBJ) para realizar implementaciones extra de manera efectiva. | **Escenario 1:** <br>Dado que existe un modelo 3D cargado, <br>Cuando el arquitecto abre el visor, <br>Entonces el sistema permite rotar y hacer zoom sobre la estructura para inspeccionar cruces de tuberías antes de la ejecución física. <br><br>**Escenario 2:** <br>Dado que el usuario intenta subir un modelo, <br>Cuando el archivo está en formato .glTF o .OBJ, <br>Entonces el sistema procesa la carga y habilita la vista interactiva en 3D. | **EP04** |
| **US-39** | Gestión de residuos de construcción | Como ayudante de logística, quiero registrar el volumen de residuos retirados de la obra para cumplir con la normativa ambiental municipal. | **Escenario 1:** <br>Dado que un camión retira residuos, <br>Cuando el usuario ingresa el volumen (m³) y la placa del vehículo, <br>Entonces el sistema suma el acumulado al reporte de cumplimiento ambiental. <br><br>**Escenario 2:** <br>Dado que el depósito temporal de residuos alcanza el 80% de su capacidad, <br>Cuando el sistema detecta el volumen, <br>Entonces envía una alerta para programar el retiro de materiales. | **EP01** |
| **US-40** | Registro de mantenimiento de maquinaria | Como ayudante de logística, quiero programar alertas de mantenimiento para las mezcladoras según horas de uso para evitar paradas por avería. | **Escenario 1:** <br>Dado que una mezcladora alcanza el hito de mantenimiento (ej. 500 horas), <br>Cuando el sistema detecta el valor, <br>Entonces envía una notificación automática al encargado para programar el servicio técnico. <br><br>**Escenario 2:** <br>Dado que se realiza un servicio, <br>Cuando el técnico registra la actividad en la app, <br>Entonces el contador de horas se reinicia y el evento queda guardado en el historial de la máquina. | **EP06** |
| **US-41** | Registro de capacitación en obra | Como supervisor de obra, quiero registrar las charlas técnicas impartidas al personal, para cumplir con el currículum de capacitación exigido por la normativa de construcción. | **Escenario 1:** <br>Dado que se imparte una capacitación, <br>Cuando el supervisor registra el tema y los participantes, <br>Entonces el sistema actualiza automáticamente el currículum de capacitación de cada trabajador asistido. <br><br>**Escenario 2:** <br>Dado que un trabajador nuevo ingresa a la obra, <br>Cuando el supervisor consulta su perfil, <br>Entonces el sistema muestra una alerta visual si el empleado aún no ha recibido la charla de inducción obligatoria. | **EP06** |
| **US-42** | Monitoreo de temperatura y humedad para curado de concreto | Como residente de obra, quiero recibir alertas automáticas cuando las condiciones ambientales no sean óptimas para el curado del concreto, para evitar fisuras y garantizar la calidad estructural. | **Escenario 1:** <br>Dado que un sensor de temperatura/humedad está instalado en el área de vaciado, <br>Cuando la temperatura supera los 35°C o la humedad baja del 40%, <br>Entonces el sistema envía una alerta push al residente y registra la condición en el reporte de calidad. <br><br>**Escenario 2:** <br>Dado que las condiciones óptimas se mantienen por el tiempo requerido (ej. 7 días), <br>Cuando se completa el período de curado, <br>Entonces el sistema marca automáticamente la partida como "Conforme" en el módulo de calidad. | **EP07** |
| **US-43** | Monitoreo de vibraciones en edificios colindantes | Como supervisor de seguridad, quiero recibir alertas en tiempo real cuando los sensores de vibración detecten movimientos peligrosos durante excavaciones, para evitar daños estructurales a propiedades vecinas. | **Escenario 1:** <br>Dado que un sensor de vibración está instalado en un edificio colindante, <br>Cuando el nivel de vibración supera el umbral seguro (ej. 5 mm/s), <br>Entonces el sistema envía una alerta prioritaria al supervisor y paraliza simbólicamente la actividad de excavación hasta su revisión. <br><br>**Escenario 2:** <br>Dado que el supervisor revisa la alerta, <br>Cuando confirma que no hay daño real y reanuda la actividad, <br>Entonces el sistema registra la acción y el tiempo de paralización en el historial de seguridad. | **EP07** |
| **US-44** | Sensor de nivel de materiales en tolvas | Como encargado de almacén, quiero recibir alertas automáticas cuando el nivel de agregados (arena, piedra) en las tolvas esté por debajo del mínimo, para solicitar reabastecimiento antes de que se agote. | **Escenario 1:** <br>Dado que un sensor ultrasónico mide el nivel de material en una tolva, <br>Cuando el nivel cae por debajo del 15% de capacidad, <br>Entonces el sistema envía una alerta de stock crítico al encargado de logística y genera automáticamente una solicitud de reabastecimiento. <br><br>**Escenario 2:** <br>Dado que el material es reabastecido, <br>Cuando el sensor detecta que el nivel supera el 80%, <br>Entonces el sistema actualiza automáticamente el inventario sin intervención manual. | **EP07** |
| **US-45** | Geolocalización de equipos de alto valor | Como encargado de almacén, quiero rastrear la ubicación de equipos de alto valor (vibrador de concreto, estación total) mediante sensores GPS, para prevenir robos y optimizar su asignación en obra. | **Escenario 1:** <br>Dado que un equipo tiene un sensor GPS integrado, <br>Cuando el sistema detecta que el equipo sale del perímetro autorizado de la obra, <br>Entonces envía una alerta inmediata al encargado de seguridad con la ubicación en tiempo real. <br><br>**Escenario 2:** <br>Dado que el encargado consulta el mapa de la obra, <br>Cuando abre el módulo de rastreo, <br>Entonces visualiza la ubicación actual de todos los equipos con GPS activos. | **EP07** |
