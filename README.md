...
| :----------| :-----------------------------------------------------------------| :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| :-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| :---------|
| **US-01** | Registro y autenticación de usuarios                             | Como gestor operativo, quiero crear una cuenta e iniciar sesión en la plataforma para acceder a los módulos de gestión de mi obra asignada.                                                                                                  | **Escenario 1 (Éxito):** <br>Dado que un profesional accede por primera vez a la aplicación, <br>Cuando proporciona los datos requeridos (Nombre, Correo, Contraseña y Rol Técnico), <br>Entonces el sistema crea la cuenta y permite el acceso a la vista principal. <br><br>**Escenario 2 (Fallo):** <br>Dado que un visitante intenta registrarse, <br>Cuando ingresa un correo electrónico que ya se encuentra registrado, <br>Entonces el sistema rechaza la solicitud e informa que el correo está en uso. <br><br>**Escenario 3 (Login):** <br>Dado que el profesional ya tiene una cuenta registrada, <br>Cuando ingresa sus credenciales válidas, <br>Entonces el sistema autentica al profesional y permite el acceso a las funcionalidades de su rol. | **EP01** |
| **US-02** | Registro de Resultado No Conforme (RNC)                          | Como supervisor de obra, quiero registrar un RNC con evidencia fotográfica para que el equipo de diseño sea alertado y subsane el error de inmediato.                                                                                        | **Escenario 1 (Éxito):** <br>Dado que el supervisor detecta una falla técnica, <br>Cuando proporciona la información de la incidencia (Título, Partida afectada, Descripción detallada) y adjunta la evidencia fotográfica, <br>Entonces el sistema genera un ticket de alerta trazable y notifica al equipo de diseño. <br><br>**Escenario 2 (Fallo):** <br>Dado que el supervisor intenta registrar la incidencia, <br>Cuando omite adjuntar la evidencia fotográfica obligatoria, <br>Entonces el sistema impide el registro y exige que se adjunte el respaldo visual.                                                                                                                                                                                       | **EP02** |
| **US-03** | Visualización de KPIs (PPC)                                      | Como gerente de proyecto, quiero visualizar el Porcentaje de Plan Completado semanal para medir la productividad real de la obra.                                                                                                            | **Escenario 1 (Éxito):** <br>Dado que el equipo ha reportado las tareas del día como finalizadas, <br>Cuando el gerente consulta los indicadores, <br>Entonces el sistema calcula automáticamente el PPC semanal y expone el resultado consolidado. <br><br>**Escenario 2 (Fallo):** <br>Dado que el gerente intenta consultar datos históricos, <br>Cuando establece un rango de fechas inválido (fecha final anterior a la inicial), <br>Entonces el sistema rechaza la consulta y advierte la inconsistencia cronológica.                                                                                                                                                                                                                                     | **EP02** |
| **US-04** | Solicitud formal de materiales                                   | Como residente de obra, quiero enviar pedidos de insumos desde la app para evitar errores de comunicación por canales informales.                                                                                                            | **Escenario 1 (Éxito):** <br>Dado que el residente requiere materiales, <br>Cuando detalla el requerimiento (Insumo, Cantidad, Unidad y Fecha máxima), <br>Entonces el sistema genera una solicitud formal con un código de seguimiento. <br><br>**Escenario 2 (Fallo):** <br>Dado que el residente intenta generar el requerimiento, <br>Cuando omite especificar la cantidad necesaria, <br>Entonces el sistema bloquea la acción y exige el volumen del material.                                                                                                                                                                                                                                                                                             | **EP03** |
| **US-05** | Alerta automática de stock crítico                               | Como encargado de almacén, quiero recibir notificaciones cuando el inventario sea bajo para evitar paralizar la construcción.                                                                                                                | **Escenario 1 (Éxito):** <br>Dado que un material tiene configurado un límite mínimo, <br>Cuando el stock registrado desciende por debajo de dicho límite tras un despacho, <br>Entonces el sistema emite una advertencia de stock crítico. <br><br>**Escenario 2 (Alternativo):** <br>Dado que el stock actual se encuentra por debajo del límite mínimo, <br>Cuando el sistema ejecuta la verificación programada, <br>Entonces envía automáticamente una notificación de reposición al área de logística.                                                                                                                                                                                                                                                     | **EP03** |
| **US-06** | Validación de compra vs presupuesto                              | Como jefe de compras, quiero que el sistema bloquee pedidos que excedan el presupuesto meta para evitar pérdidas de utilidad.                                                                                                                | **Escenario 1 (Fallo/Bloqueo):** <br>Dado que el jefe de compras intenta procesar un pedido que excede el monto presupuestado, <br>Cuando intenta confirmar la transacción, <br>Entonces el sistema bloquea la operación e informa del exceso presupuestal. <br><br>**Escenario 2 (Éxito):** <br>Dado que el pedido se encuentra dentro del presupuesto disponible, <br>Cuando confirma la transacción, <br>Entonces el sistema aprueba la compra y descuenta el monto total de los fondos.                                                                                                                                                                                                                                                                      | **EP03** |
| **US-07** | Firma digital de actas con token                                 | Como ingeniero residente, quiero firmar actas de conformidad con un código de verificación para asegurar la validez legal del cierre de etapa.                                                                                               | **Escenario 1 (Éxito):** <br>Dado que el residente aprueba la partida técnica, <br>Cuando proporciona el código numérico de seguridad válido, <br>Entonces el sistema sella digitalmente el documento de conformidad. <br><br>**Escenario 2 (Fallo):** <br>Dado que el residente intenta validar la firma, <br>Cuando ingresa un código de seguridad incorrecto o con longitud inválida, <br>Entonces el sistema rechaza la firma y mantiene el acta en estado pendiente.                                                                                                                                                                                                                                                                                        | **EP02** |
| **US-08** | Atender solicitud de materiales                                  | Como encargado de logística, quiero cambiar el estado de las solicitudes de materiales a "Aprobado" o "Rechazado", para mantener al equipo de obra informado sobre la disponibilidad de los insumos.                                         | **Escenario 1 (Éxito):** <br>Dado que existe una solicitud en estado pendiente, <br>Cuando el responsable aprueba el requerimiento, <br>Entonces el sistema actualiza el estado a "En proceso de compra" para visibilidad del solicitante. <br><br>**Escenario 2 (Fallo/Rechazo):** <br>Dado que el responsable decide rechazar la solicitud, <br>Cuando intenta confirmar el rechazo sin proporcionar una justificación, <br>Entonces el sistema impide la acción hasta que se detalle el motivo.                                                                                                                                                                                                                                                               | **EP03** |
| **US-09** | Actualizar inventario general                                    | Como encargado de logística, quiero actualizar las cantidades de los materiales en el almacén central, para mantener un registro exacto del stock físico disponible para las obras.                                                          | **Escenario 1 (Éxito):** <br>Dado que el logístico registra el ingreso de nuevos materiales, <br>Cuando especifica una cantidad positiva a sumar, <br>Entonces el sistema recalcula e incrementa el stock actual. <br><br>**Escenario 2 (Fallo):** <br>Dado que el logístico intenta modificar el stock, <br>Cuando ingresa un valor negativo o no numérico, <br>Entonces el sistema rechaza el dato y exige un valor numérico positivo.                                                                                                                                                                                                                                                                                                                         | **EP03** |
| **US-10** | Registrar avance diario de obra                                  | Como residente de obra, quiero registrar el porcentaje de avance físico del proyecto diariamente, para mantener la trazabilidad de la ejecución real frente al cronograma.                                                                   | **Escenario 1 (Éxito):** <br>Dado que el residente evalúa la jornada, <br>Cuando registra un avance válido entre 1% y 100% junto con la fecha, <br>Entonces el sistema almacena el progreso y actualiza el indicador general. <br><br>**Escenario 2 (Fallo):** <br>Dado que el residente intenta reportar el avance, <br>Cuando especifica un porcentaje superior al 100%, <br>Entonces el sistema impide el guardado por considerarlo un valor irreal.                                                                                                                                                                                                                                                                                                          | **EP02** |
| **US-11** | Cambiar estado del proyecto                                      | Como administrador del sistema, quiero modificar el estado global de una obra (ej. En ejecución, Paralizada, Finalizada), para reflejar la situación operativa actual ante todos los usuarios.                                               | **Escenario 1 (Éxito):** <br>Dado que el administrador modifica las configuraciones, <br>Cuando cambia el estado a "Paralizada" y documenta la justificación, <br>Entonces el sistema restringe la creación de nuevos requerimientos para dicha obra. <br><br>**Escenario 2 (Fallo):** <br>Dado que el administrador intenta paralizar la obra, <br>Cuando omite redactar la justificación obligatoria, <br>Entonces el sistema bloquea la actualización del estado.                                                                                                                                                                                                                                                                                             | **EP02** |
| **US-12** | Visualizar Dashboard logístico                                   | Como encargado de logística, quiero visualizar un resumen gráfico de requerimientos pendientes y presupuesto ejecutado, para tomar decisiones de compra rápidas sin tener que cruzar datos de Excel.                                         | **Escenario 1 (Éxito):** <br>Dado que el profesional de logística accede al sistema, <br>Cuando consulta el resumen logístico, <br>Entonces el sistema consolida y expone las proporciones de solicitudes y el gasto acumulado. <br><br>**Escenario 2 (Alternativo):** <br>Dado que no existe historial operativo en el periodo, <br>Cuando el profesional accede a la vista de resumen, <br>Entonces el sistema informa claramente la ausencia de transacciones registradas.                                                                                                                                                                                                                                                                                    | **EP03** |
| **US-13** | Asignar roles a usuarios                                         | Como administrador del sistema, quiero asignar o modificar los permisos de los trabajadores en la plataforma, para asegurar que cada empleado solo tenga acceso a los módulos correspondientes a su cargo.                                   | **Escenario 1 (Éxito):** <br>Dado que el administrador gestiona las cuentas, <br>Cuando asigna el rol de "Encargado de Logística" a un perfil básico, <br>Entonces el sistema otorga acceso al módulo de inventarios y revoca permisos de otras áreas. <br><br>**Escenario 2 (Fallo/Auto-bloqueo):** <br>Dado que el administrador visualiza su propio perfil, <br>Cuando intenta modificar sus credenciales de administrador, <br>Entonces el sistema impide la acción para evitar que pierda sus privilegios.                                                                                                                                                                                                                                                  | **EP01** |
| **US-14** | Exportación de base de datos                                     | Como administrador, quiero exportar la información del proyecto en formatos abiertos (.csv, .json) para garantizar la soberanía de los datos.                                                                                                | **Escenario 1 (Éxito):** <br>Dado que el administrador accede a las opciones de respaldo, <br>Cuando solicita la información en un formato específico, <br>Entonces el sistema compila los datos y provee un archivo descargable. <br><br>**Escenario 2 (Fallo de Acceso):** <br>Dado que un residente intenta ejecutar un respaldo, <br>Cuando solicita la acción de exportación global, <br>Entonces el sistema le deniega el acceso por falta de permisos.                                                                                                                                                                                                                                                                                                    | **EP05** |
| **US-15** | Control de mermas y desperdicios                                 | Como encargado de almacén, quiero registrar la merma de materiales para ajustar el stock real y analizar la eficiencia de los recursos.                                                                                                      | **Escenario 1 (Éxito):** <br>Dado que el encargado identifica una merma, <br>Cuando registra la cantidad y la categoriza como pérdida, <br>Entonces el sistema deduce el material del inventario activo. <br><br>**Escenario 2 (Fallo/Alerta):** <br>Dado que el volumen de merma supera la tolerancia permitida, <br>Cuando el encargado procesa el registro, <br>Entonces el sistema completa la acción pero emite inmediatamente una advertencia a la gerencia.                                                                                                                                                                                                                                                                                               | **EP03** |
| **US-16** | Reporte fotográfico diario                                       | Como residente de obra, quiero subir fotos diarias del frente de trabajo para generar una bitácora visual de sustento.                                                                                                                       | **Escenario 1 (Éxito):** <br>Dado que el residente reporta el cierre de jornada, <br>Cuando provee archivos de imagen válidos y los vincula a una partida, <br>Entonces el sistema los archiva en la línea de tiempo del proyecto. <br><br>**Escenario 2 (Fallo):** <br>Dado que el residente intenta documentar el avance, <br>Cuando proporciona archivos en formato no soportado (ej. videos), <br>Entonces el sistema rechaza la carga informando la incompatibilidad.                                                                                                                                                                                                                                                                                       | **EP02** |
| **US-17** | Acceso de visualización para Cliente                             | Como cliente de la obra, quiero tener acceso de solo lectura para monitorear el avance físico y financiero de mi inversión.                                                                                                                  | **Escenario 1 (Éxito):** <br>Dado que el cliente ingresa con su perfil específico, <br>Cuando navega por los módulos del proyecto, <br>Entonces el sistema restringe totalmente sus permisos de creación, edición o eliminación. <br><br>**Escenario 2 (Fallo/Acción Restringida):** <br>Dado que el cliente consulta la planificación, <br>Cuando intenta manipular las fechas o tareas establecidas, <br>Entonces el sistema rechaza las alteraciones y preserva la integridad de los datos.                                                                                                                                                                                                                                                                   | **EP02** |
| **US-18** | Alerta de desviación presupuestal                                | Como jefe de oficina técnica, quiero recibir notificaciones si el gasto real supera el presupuesto meta para tomar medidas correctivas.                                                                                                      | **Escenario 1 (Éxito/Alerta):** <br>Dado que logística finaliza una transacción, <br>Cuando el precio unitario sobrepasa el límite estimado en el presupuesto, <br>Entonces el sistema emite una notificación de advertencia sobre el sobrecosto. <br><br>**Escenario 2 (Fallo/Desviación Crítica):** <br>Dado que el gerente audita el estado financiero, <br>Cuando una partida presenta una varianza superior al margen aceptable, <br>Entonces el sistema resalta el indicador para asegurar la detección del problema.                                                                                                                                                                                                                                      | **EP02** |
| **US-19** | Préstamo de herramientas                                         | Como encargado de almacén, quiero controlar el préstamo de equipos a las cuadrillas para evitar pérdidas y gestionar el mantenimiento.                                                                                                       | **Escenario 1 (Éxito):** <br>Dado que un operario solicita un equipo menor, <br>Cuando el encargado vincula la herramienta a la identidad del operario, <br>Entonces el sistema actualiza el estado de la herramienta a "En Uso". <br><br>**Escenario 2 (Fallo):** <br>Dado que se procesa el retorno de un equipo, <br>Cuando el encargado indica que presenta daños pero no añade observaciones, <br>Entonces el sistema impide completar la devolución hasta justificar el daño.                                                                                                                                                                                                                                                                              | **EP03** |
| **US-20** | Activación de Plugins                                            | Como desarrollador, quiero habilitar módulos adicionales mediante la API de Kipu para extender las funciones básicas del sistema.                                                                                                            | **Escenario 1 (Éxito):** <br>Dado que el administrador posee una extensión autorizada, <br>Cuando provee el archivo empaquetado para instalación, <br>Entonces el sistema valida su firma y despliega la nueva funcionalidad. <br><br>**Escenario 2 (Fallo):** <br>Dado que se intenta instalar un paquete no autorizado, <br>Cuando la extensión carece de los parámetros técnicos correctos, <br>Entonces el sistema aborta el proceso y expone el registro de error.                                                                                                                                                                                                                                                                                          | **EP05** |
| **US-21** | Registro de desperdicios y devoluciones                          | Como encargado de almacén, quiero registrar la cantidad de material dañado o sobrante por cada jornada, para ajustar las futuras compras y reducir el desperdicio acumulado.                                                                 | **Escenario 1 (Éxito):** <br>Dado que se gestiona material sobrante en buen estado, <br>Cuando se registra como devolución al proveedor, <br>Entonces el sistema ajusta el inventario y genera un registro de crédito a favor. <br><br>**Escenario 2 (Fallo):** <br>Dado que se intenta reportar material dañado, <br>Cuando el encargado omite declarar el volumen afectado, <br>Entonces el sistema rechaza la operación por datos insuficientes.                                                                                                                                                                                                                                                                                                              | **EP03** |
| **US-22** | Bitácora fotográfica de excavaciones                             | Como supervisor de obras, quiero crear una galería específica para la etapa de excavación para documentar el tipo de suelo encontrado y evitar reclamos futuros.                                                                             | **Escenario 1 (Éxito):** <br>Dado que el supervisor recaba evidencia del terreno, <br>Cuando asigna las imágenes a la categoría de suelos/excavación, <br>Entonces el sistema las clasifica en un repositorio segregado. <br><br>**Escenario 2 (Fallo):** <br>Dado que se requiere exportar el reporte de suelos, <br>Cuando no existen evidencias etiquetadas en dicha categoría, <br>Entonces el sistema informa la ausencia de archivos vinculados.                                                                                                                                                                                                                                                                                                           | **EP02** |
| **US-23** | Seguimiento de órdenes de cambio                                 | Como gerente de proyecto, quiero registrar modificaciones al contrato original solicitadas por el cliente para ajustar el presupuesto y cronograma oficial.                                                                                  | **Escenario 1 (Éxito):** <br>Dado que el cliente requiere una ampliación del proyecto, <br>Cuando el gerente incorpora las nuevas partidas al plan, <br>Entonces el sistema actualiza de manera inmediata el cálculo financiero total. <br><br>**Escenario 2 (Fallo en Fechas):** <br>Dado que el gerente ajusta el cronograma, <br>Cuando intenta programar una tarea fuera del límite temporal del proyecto, <br>Entonces el sistema identifica la discrepancia e impide la modificación.                                                                                                                                                                                                                                                                      | **EP02** |
| **US-24** | Control de herramientas asignadas                                | Como encargado de almacén, quiero registrar las herramientas eléctricas asignadas (taladros, amoladoras) a un obrero específico para que sea el responsable de su devolución en buen estado.                                                 | **Escenario 1 (Éxito):** <br>Dado que se entrega una herramienta serializada, <br>Cuando se vincula oficialmente a un operario registrado, <br>Entonces el sistema transfiere su estado a "Asignado". <br><br>**Escenario 2 (Fallo):** <br>Dado que se intenta asignar equipamiento, <br>Cuando el identificador del trabajador no existe en los registros activos, <br>Entonces el sistema invalida la búsqueda y detiene el proceso de entrega.                                                                                                                                                                                                                                                                                                                | **EP03** |
| **US-25** | Monitoreo de temperatura y humedad para curado de concreto (IoT) | Como residente de obra, quiero recibir alertas automáticas cuando las condiciones ambientales no sean óptimas para el curado del concreto, para evitar fisuras y garantizar la calidad estructural.                                          | **Escenario 1 (Éxito/Alerta):** <br>Dado que el sistema recibe datos telemétricos del sensor, <br>Cuando la medición excede el parámetro de temperatura segura, <br>Entonces el sistema despacha una advertencia inmediata de riesgo al residente. <br><br>**Escenario 2 (Fallo de conexión IoT):** <br>Dado que un sensor físico sufre una interrupción, <br>Cuando el sistema no recibe información en un periodo crítico, <br>Entonces se actualiza el estado del dispositivo alertando su desconexión.                                                                                                                                                                                                                                                       | **EP04** |
| **US-26** | Monitoreo de vibraciones en edificios colindantes (IoT)          | Como supervisor de seguridad, quiero recibir alertas en tiempo real cuando los sensores de vibración detecten movimientos peligrosos durante excavaciones, para evitar daños estructurales a propiedades vecinas.                            | **Escenario 1 (Éxito/Bloqueo):** <br>Dado que se reciben datos sísmicos en tiempo real, <br>Cuando la vibración sobrepasa el margen de seguridad preestablecido, <br>Entonces el sistema activa un bloqueo restrictivo en el módulo de excavación. <br><br>**Escenario 2 (Liberación):** <br>Dado que el protocolo de seguridad se ha activado, <br>Cuando el supervisor se autentica para autorizar la reanudación, <br>Entonces el sistema levanta las restricciones y audita la autorización.                                                                                                                                                                                                                                                                 | **EP04** |
| **US-27** | Sensor de nivel de materiales en tolvas (IoT)                    | Como encargado de almacén, quiero recibir alertas automáticas cuando el nivel de agregados (arena, piedra) en las tolvas esté por debajo del mínimo, para solicitar reabastecimiento antes de que se agote.                                  | **Escenario 1 (Éxito/Ticket automático):** <br>Dado que las mediciones del silo indican escasez, <br>Cuando el nivel cae por debajo de la regla configurada, <br>Entonces el sistema emite automáticamente una orden de reabastecimiento. <br><br>**Escenario 2 (Recarga automática):** <br>Dado que se efectúa una recarga física de insumos, <br>Cuando el sensor registra el incremento de volumen, <br>Entonces el sistema sincroniza automáticamente las cifras del inventario.                                                                                                                                                                                                                                                                             | **EP04** |
| **US-28** | Geolocalización de equipos de alto valor (IoT)                   | Como encargado de almacén, quiero rastrear la ubicación de equipos de alto valor (vibrador de concreto, estación total) mediante sensores GPS, para prevenir robos y optimizar su asignación en obra.                                        | **Escenario 1 (Éxito):** <br>Dado que un equipo emite coordenadas constantes, <br>Cuando el encargado consulta la herramienta de rastreo, <br>Entonces el sistema proyecta la localización precisa de forma continua. <br><br>**Escenario 2 (Fallo/Geocerca):** <br>Dado que el administrador delimitó el área autorizada, <br>Cuando el equipo transmite coordenadas externas a la zona permitida, <br>Entonces el sistema dispara notificaciones urgentes advirtiendo la sustracción.                                                                                                                                                                                                                                                                          | **EP04** |
| **US-29** | Landing page - Visualización de propuesta de valor               | Como profesional del sector construcción que visita el sitio web, quiero conocer la propuesta de valor y funcionalidades principales de Kipu para entender cómo puede ayudarme en mis proyectos de construcción.                             | **Escenario 1 (Éxito):** <br>Dado que un prospecto ingresa al sitio público, <br>Cuando se le presenta la vista inicial, <br>Entonces el sistema expone el propósito de la herramienta y la opción de integración. <br><br>**Escenario 2 (Navegación):** <br>Dado que el usuario explora los detalles de la oferta, <br>Cuando avanza hacia el contenido descriptivo, <br>Entonces el sistema presenta el desglose de las características operativas clave.                                                                                                                                                                                                                                                                                                      | **EP06** |
| **US-30** | Landing page - Contenido para gestores operativos                | Como arquitecto o ingeniero que visita el sitio, quiero encontrar información específica sobre cómo Kipu mejora la supervisión técnica y trazabilidad de obra para evaluar si se adapta a mis necesidades profesionales.                     | **Escenario 1 (Éxito):** <br>Dado que un técnico explora la información dirigida a su área, <br>Cuando consulta los beneficios específicos, <br>Entonces el sistema muestra los detalles técnicos y la opción de registro. <br><br>**Escenario 2 (Redirección):** <br>Dado que el técnico decide crear una cuenta desde su sección, <br>Cuando solicita el alta en el sistema, <br>Entonces se le redirige al proceso de inscripción pre-asignando su especialidad.                                                                                                                                                                                                                                                                                              | **EP06** |
| **US-31** | Landing page - Contenido para equipos de logística               | Como responsable de logística o administración que visita el sitio, quiero encontrar información específica sobre cómo Kipu centraliza pedidos y controla presupuestos para convencerme de su utilidad en mi área.                           | **Escenario 1 (Éxito):** <br>Dado que un administrativo interactúa con el contenido financiero, <br>Cuando solicita una demostración del producto, <br>Entonces el sistema le exige la información corporativa necesaria. <br><br>**Escenario 2 (Fallo):** <br>Dado que el administrativo intenta cursar su petición, <br>Cuando no provee datos de contacto válidos, <br>Entonces el sistema suspende la solicitud y requiere la corrección.                                                                                                                                                                                                                                                                                                                    | **EP06** |
| **US-32** | Landing page - Misión y visión de PircaIndustries                | Como visitante potencial, quiero conocer la misión y visión de PircaIndustries para evaluar la confianza y dirección de largo plazo del proyecto Kipu.                                                                                       | **Escenario 1 (Éxito):** <br>Dado que el visitante consulta los antecedentes corporativos, <br>Cuando accede a la información institucional, <br>Entonces el sistema expone los principios y proyecciones de la empresa. <br><br>**Escenario 2 (Navegación):** <br>Dado que el visitante finaliza su lectura corporativa, <br>Cuando elige retornar a la propuesta principal, <br>Entonces el sistema transiciona fluidamente hacia la presentación del producto.                                                                                                                                                                                                                                                                                                | **EP06** |
| **US-33** | Landing page - Canales de contacto y formulario                  | Como visitante interesado, quiero disponer de canales de contacto y un formulario para comunicarme con el equipo de Kipu sin salir del sitio.                                                                                                | **Escenario 1 (Éxito):** <br>Dado que un interesado utiliza el medio de comunicación, <br>Cuando provee un mensaje con datos completos, <br>Entonces el sistema procesa la solicitud y confirma su recepción. <br><br>**Escenario 2 (Fallo):** <br>Dado que se intenta emitir una comunicación, <br>Cuando faltan parámetros esenciales como el remitente, <br>Entonces el sistema detiene el envío y señala las omisiones.                                                                                                                                                                                                                                                                                                                                      | **EP06** |
| **US-34** | Landing page - Llamados a la acción de registro y demo           | Como visitante que ya entendió la propuesta, quiero ver llamados a la acción visibles para registrarme o solicitar demo y avanzar al siguiente paso.                                                                                         | **Escenario 1 (Éxito):** <br>Dado que el prospecto evalúa sus alternativas, <br>Cuando selecciona iniciar el uso del software o agendar una cita, <br>Entonces el sistema procesa la intención dirigiéndolo al flujo preciso. <br><br>**Escenario 2 (Persistencia):** <br>Dado que el visitante concluye su revisión de todo el sitio, <br>Cuando se sitúa en la parte inferior, <br>Entonces el sistema mantiene latentes las opciones de conversión.                                                                                                                                                                                                                                                                                                           | **EP06** |
| **US-35** | **Creación de nuevo proyecto de obra**                           | Como Gestor Operativo de Obra, quiero registrar una nueva obra en el sistema para iniciar su gestión operativa y trazabilidad.                                                                                                               | **Escenario 1 (Éxito):** <br>Dado que el responsable gestiona su cartera, <br>Cuando aporta los datos esenciales del nuevo proyecto, <br>Entonces el sistema consolida la obra en fase inicial y la asocia a su perfil. <br><br>**Escenario 2 (Fallo/Duplicado):** <br>Dado que se intenta dar de alta una construcción, <br>Cuando el nombre designado ya se encuentra activo, <br>Entonces el sistema objeta el registro para impedir redundancias.                                                                                                                                                                                                                                                                                                            | **EP02** |
| **US-36** | **Carga de presupuesto base**                                    | Como miembro del Equipo de Logística y Administración, quiero cargar el presupuesto inicial para tener un tope financiero al validar compras y requerimientos.                                                                               | **Escenario 1 (Éxito):** <br>Dado que la obra se encuentra en estatus de planificación, <br>Cuando se introducen las asignaciones monetarias preliminares, <br>Entonces el sistema instaura el tope económico y habilita el seguimiento. <br><br>**Escenario 2 (Fallo/Monto Cero):** <br>Dado que se intentan asentar los montos base, <br>Cuando los valores declarados carecen de magnitud económica, <br>Entonces el sistema deniega el registro exigiendo un fondo válido.                                                                                                                                                                                                                                                                                   | **EP03** |
| **US-37** | **Creación de cronograma y partidas**                            | Como Gestor Operativo de Obra, quiero estructurar las partidas (tareas) y fechas límite para poder medir el Porcentaje de Plan Completado (PPC) durante la ejecución.                                                                        | **Escenario 1 (Éxito):** <br>Dado que se planifican los tiempos operativos, <br>Cuando se configuran las dependencias y plazos de las labores, <br>Entonces el sistema las asimila y consolida el calendario oficial. <br><br>**Escenario 2 (Fallo/Fechas Ilógicas):** <br>Dado que se organizan los plazos de ejecución, <br>Cuando se dictamina que una labor concluye antes de iniciar, <br>Entonces el sistema reconoce la falla lógica e imposibilita su grabación.                                                                                                                                                                                                                                                                                         | **EP02** |
| **US-38** | Historial de cambios en planos                                   | Como Residente de Obra, quiero visualizar el registro de versiones de un plano para entender la evolución del diseño.                                                                                                                        | **Escenario 1 (Éxito):** <br>Dado que el técnico revisa los anexos estructurales, <br>Cuando solicita examinar la trazabilidad de un diseño, <br>Entonces el sistema desglosa todas sus iteraciones y responsabilidades históricas.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | **EP07** |
| **US-39** | Subir nueva versión de plano                                     | Como Ingeniero de Diseño, quiero cargar actualizaciones de los planos para que el equipo en campo trabaje con la información final.                                                                                                          | **Escenario 1 (Éxito):** <br>Dado que se efectúan correcciones sobre un diseño, <br>Cuando se provee la iteración mejorada del archivo, <br>Entonces el sistema eleva el nivel de vigencia y relega al anterior a estatus obsoleto.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | **EP07** |
| **US-40** | Descarga para uso Offline                                        | Como Residente de Obra, quiero guardar planos en mi dispositivo para consultarlos en zonas sin conectividad (sótanos).                                                                                                                       | **Escenario 1 (Éxito):** <br>Dado que el trabajador prevé adentrarse en zonas incomunicadas, <br>Cuando demanda la extracción preventiva de la documentación, <br>Entonces el sistema empaqueta los archivos garantizando su lectura sin dependencia de red.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | **EP07** |
| **US-41** | Registro de interferencias (Anotaciones)                         | Como Supervisor de Obra, quiero realizar anotaciones gráficas sobre el plano para reportar errores de diseño detectados en campo.                                                                                                            | **Escenario 1 (Éxito):** <br>Dado que se evalúa la factibilidad de un trazo, <br>Cuando se adjuntan precisiones de discrepancia técnica, <br>Entonces el sistema indexa el apunte preservando el documento original.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | **EP07** |
| **US-42** | Visualización interactiva 3D                                     | Como Gestor Operativo, quiero inspeccionar modelos tridimensionales para comprender cruces de instalaciones complejos.                                                                                                                       | **Escenario 1 (Éxito):** <br>Dado que el archivo contiene modelado espacial, <br>Cuando el operario requiere una evaluación profunda, <br>Entonces el sistema dispone herramientas para analizar volumétricamente el diseño.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | **EP07** |
| **US-43** | Filtro de planos por especialidad                                | Como Gestor Operativo, quiero segmentar la lista de archivos por rama técnica para localizar información crítica rápidamente.                                                                                                                | **Escenario 1 (Éxito):** <br>Dado que coexisten distintas disciplinas en el proyecto, <br>Cuando el usuario delimita su interés a una rama específica, <br>Entonces el sistema discrimina e ignora la documentación ajena a dicha solicitud.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | **EP07** |
| **US-44** | Ordenamiento cronológico de planos                               | Como Equipo de Logística, quiero organizar los documentos por fecha de carga para identificar los últimos requerimientos técnicos.                                                                                                           | **Escenario 1 (Éxito):** <br>Dado que se evalúan las exigencias documentales, <br>Cuando se aplica un criterio de orden temporal, <br>Entonces el sistema altera la presentación priorizando lo más reciente.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | **EP07** |
| **US-45** | Exportación de Dossier de Calidad en PDF                         | Como administrador de proyecto, quiero exportar un archivo PDF que contenga todo el historial de firmas electrónicas y aprobaciones de una etapa constructiva, para facilitar la entrega del proyecto a la municipalidad o al cliente final. | **Escenario 1 (Éxito):** <br>Dado que una fase técnica concluye formalmente, <br>Cuando se requiere el compendio de certificaciones, <br>Entonces el sistema genera un paquete único e inalterable con las validaciones documentadas. <br><br>**Escenario 2 (Exportación filtrada):** <br>Dado que la supervisión externa demanda certificaciones puntuales, <br>Cuando se restringe la orden a un periodo específico, <br>Entonces el sistema provee un compendio limitado únicamente a lo delimitado.                                                                                                                                                                                                                                                          | **EP02** |
...
| **TS06**               | Get Project           | **Como** usuario developer, **quiero** consultar la lista de obras, **para** mostrar los indicadores de avance en la aplicación.                                    | **Escenario 1: Obtener informacion de Project**<br>Dado que el endpoint "/proyectos" está disponible,<br>Cuando se envía una solicitud GET,<br>Entonces se recibe una respuesta con estado 200 y la lista de proyectos.<br>**Escenario 2: Obtener informacion de Project no disponible**<br>Dado que el endpoint "/proyectos" está disponible,<br>Cuando no existen proyectos registrados en la base de datos,<br>Entonces se recibe una respuesta con estado 200 y un arreglo vacío.                                       | **EP02**  |
