...
| **US-23** | Préstamo de herramientas | Como encargado de almacén, quiero controlar el préstamo de equipos a las cuadrillas para evitar pérdidas y gestionar el mantenimiento. | **Escenario 1 (Éxito):** <br>Dado que un operario requiere un equipo menor, <br>Cuando el almacenero busca el DNI en el buscador y asocia la herramienta, <br>Entonces el badge de la herramienta cambia visualmente a "En Uso". <br><br>**Escenario 2 (Fallo):** <br>Dado que se registra el retorno del equipo, <br>Cuando el almacenero selecciona el radio button "Devuelto con Daños" y no escribe justificación, <br>Entonces el botón de guardado no se habilita exigiendo detalles en el textarea. | **EP03** |
| **US-24** | Activación de Plugins | Como desarrollador, quiero habilitar módulos adicionales mediante la API de Kipu para extender las funciones básicas del sistema. | **Escenario 1 (Éxito):** <br>Dado que el administrador cuenta con un plugin compatible, <br>Cuando carga el archivo `.zip` en el input file y pulsa "Instalar", <br>Entonces el núcleo lo procesa y despliega una nueva sección funcional en el Sidebar. <br><br>**Escenario 2 (Fallo):** <br>Dado que el `.zip` cargado no cumple con la firma técnica del software, <br>Cuando pulsa "Instalar", <br>Entonces el sistema arroja un Modal Error con el trace log, denegando la instalación. | **EP05** |
| **US-25** | Registro de desperdicios y devoluciones | Como encargado de almacén, quiero registrar la cantidad de material dañado o sobrante por cada jornada, para ajustar las futuras compras y reducir el desperdicio acumulado. | **Escenario 1 (Éxito):** <br>Dado que existe material sobrante reutilizable, <br>Cuando el almacenero selecciona "Devolución a proveedor" en el menú desplegable y guarda, <br>Entonces el sistema descuenta el material y renderiza una nota de crédito a favor. <br><br>**Escenario 2 (Fallo):** <br>Dado que el almacenero intenta registrar un "Desperdicio", <br>Cuando deja la cantidad del desperdicio en blanco o igual a 0, <br>Entonces el formulario marca el error e impide registrar un volumen irreal. | **EP03** |
| **US-26** | Bitácora fotográfica de excavaciones | Como supervisor de obras, quiero crear una galería específica para la etapa de excavación para documentar el tipo de suelo encontrado y evitar reclamos futuros. | **Escenario 1 (Éxito):** <br>Dado que el operario toma fotos del terreno, <br>Cuando las sube activando el checkbox "Suelo/Excavación", <br>Entonces la UI filtra y aísla esas imágenes en una carpeta apartada del álbum general. <br><br>**Escenario 2 (Fallo):** <br>Dado que el cliente solicita el reporte fotográfico de suelos, <br>Cuando el supervisor presiona el botón "Descargar Evidencia" y la carpeta de excavación está vacía, <br>Entonces se dispara una alerta indicando "No existen fotos etiquetadas para esta partida". | **EP02** |
| **US-27** | Seguimiento de órdenes de cambio | Como gerente de proyecto, quiero registrar modificaciones al contrato original solicitadas por el cliente para ajustar el presupuesto y cronograma oficial. | **Escenario 1 (Éxito):** <br>Dado que el cliente exige agregar un nivel extra, <br>Cuando el gerente añade las nuevas filas presupuestales en la "Orden de Cambio", <br>Entonces una tarjeta inferior totalizadora refleja en vivo el impacto monetario adicional. <br><br>**Escenario 2 (Fallo en Fechas):** <br>Dado que el gerente actualiza los plazos por la orden de cambio, <br>Cuando ingresa una fecha de inicio de la nueva partida superior a la fecha de fin de obra general, <br>Entonces el Datepicker marca error de lógica de fechas impidiendo guardar. | **EP02** |
