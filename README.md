...
| **US-26** | Préstamo de herramientas | Como encargado de almacén, quiero controlar el préstamo de equipos a las cuadrillas para evitar pérdidas y gestionar el mantenimiento. | **Escenario 1 (Éxito):** <br>Dado que un operario requiere un equipo menor, <br>Cuando el almacenero busca el DNI en el buscador y asocia la herramienta, <br>Entonces el badge de la herramienta cambia visualmente a "En Uso". <br><br>**Escenario 2 (Fallo):** <br>Dado que se registra el retorno del equipo, <br>Cuando el almacenero selecciona el radio button "Devuelto con Daños" y no escribe justificación, <br>Entonces el botón de guardado no se habilita exigiendo detalles en el textarea. | **EP03** |
| **US-27** | Activación de Plugins | Como desarrollador, quiero habilitar módulos adicionales mediante la API de Kipu para extender las funciones básicas del sistema. | **Escenario 1 (Éxito):** <br>Dado que el administrador cuenta con un plugin compatible, <br>Cuando carga el archivo `.zip` en el input file y pulsa "Instalar", <br>Entonces el núcleo lo procesa y despliega una nueva sección funcional en el Sidebar. <br><br>**Escenario 2 (Fallo):** <br>Dado que el `.zip` cargado no cumple con la firma técnica del software, <br>Cuando pulsa "Instalar", <br>Entonces el sistema arroja un Modal Error con el trace log, denegando la instalación. | **EP05** |
| **US-28** | Anotaciones digitales sobre planos | Como residente de obra, quiero realizar anotaciones digitales sobre el plano de cimentación, para reportar interferencias detectadas en campo inmediatamente al equipo de diseño. | **Escenario 1 (Éxito):** <br>Dado que el residente inspecciona el visor PDF del plano, <br>Cuando hace clic en el canvas, escribe el texto en el globo emergente y guarda, <br>Entonces se posiciona un marcador visual (Pin) sobre esa coordenada específica. <br><br>**Escenario 2 (Fallo):** <br>Dado que el residente hace clic en el plano para reportar, <br>Cuando presiona "Enviar anotación" con la caja de texto completamente vacía, <br>Entonces el contorno del cuadro de texto se vuelve rojo, impidiendo la creación del pin. | **EP04** |
