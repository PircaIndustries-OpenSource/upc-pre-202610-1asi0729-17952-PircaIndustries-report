...
| **EP04** | **Gestión documental de planos, versiones y anotaciones**  | Como profesional técnico, quiero acceder a planos actualizados, gestionar versiones, realizar anotaciones digitales y generar dossieres de calidad para mantener un registro histórico completo del proyecto. | **Escenario 1: Filtro de planos por especialidad** <br>Dado que el técnico visualiza la lista de documentos, <br>Cuando selecciona el filtro de especialidad requerida, <br>Entonces la aplicación muestra únicamente los planos de esa categoría. <br><br> **Escenario 2: Historial de versiones con notificaciones** <br>Dado que el arquitecto consulta un plano, <br>Cuando abre la sección de historial, <br>Entonces el sistema lista todas las versiones previas con fecha, responsable y cambios, y envía alertas cuando se publica una nueva versión. <br><br> **Escenario 3: Anotaciones digitales sobre planos** <br>Dado que el residente detecta una interferencia en campo, <br>Cuando selecciona un área del plano y agrega una anotación, <br>Entonces el sistema guarda la observación y notifica al equipo de diseño. <br><br> **Escenario 4: Generación de dossier de calidad** <br>Dado que el proyecto está en etapa de cierre, <br>Cuando el gerente solicita la exportación del dossier, <br>Entonces el sistema genera un PDF con todo el historial de RNCs, firmas y aprobaciones. |
...
| :----------| :---------------------------------------------------------------------------| :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| :---------|
| **US-01** | Registro y autenticación de usuarios                                       | Como gestor operativo, quiero crear una cuenta e iniciar sesión en la plataforma para acceder a los módulos de gestión de mi obra asignada.                                                                              | **Escenario 1 (Éxito):**<br>Dado que un profesional accede por primera vez a la aplicación,<br>Cuando completa el formulario de registro con los campos obligatorios: Nombre completo, Correo electrónico, Contraseña alfanumérica y Rol Técnico,<br>Entonces el sistema crea la cuenta y lo redirige al Dashboard principal.<br><br>**Escenario 2 (Fallo):**<br>Dado que un visitante intenta registrarse,<br>Cuando ingresa un Correo electrónico que ya está registrado y envía el formulario,<br>Entonces el sistema detiene el proceso y muestra un mensaje de error rojo bajo el input.<br><br>**Escenario 3 (Login):**<br>Dado que el profesional ya tiene una cuenta registrada,<br>Cuando ingresa sus credenciales válidas en el formulario de login,<br>Entonces el sistema autentica al profesional y lo redirige a su vista correspondiente según su rol. | **EP01** |
| **US-02** | Registro de Resultado No Conforme (RNC)                                    | Como supervisor de obra, quiero registrar un RNC con evidencia fotográfica para que el equipo de diseño sea alertado y subsane el error de inmediato.                                                                    | **Escenario 1 (Éxito):**<br>Dado que el supervisor detecta una falla técnica,<br>Cuando completa el formulario ingresando: Título, Partida afectada, Descripción detallada y adjunta al menos una fotografía en el campo file,<br>Entonces el sistema genera un ticket de alerta trazable y notifica al equipo de diseño.<br><br>**Escenario 2 (Fallo):**<br>Dado que el supervisor olvida adjuntar una foto obligatoria,<br>Cuando intenta enviar el formulario RNC,<br>Entonces el botón de envío se deshabilita y se muestra un requerimiento visual solicitando evidencia fotográfica.                                                                                                                                                                                                                                                                            | **EP02** |
| **US-03** | Visualización de KPIs (PPC)                                                | Como gerente de proyecto, quiero visualizar el Porcentaje de Plan Completado semanal para medir la productividad real de la obra.                                                                                        | **Escenario 1 (Éxito):**<br>Dado que el equipo ha marcado las tareas del día como finalizadas,<br>Cuando el gerente accede al módulo de indicadores,<br>Entonces el sistema calcula automáticamente el PPC semanal y renderiza el resultado en un gráfico de barras.<br><br>**Escenario 2 (Fallo):**<br>Dado que el gerente intenta filtrar el dashboard con el calendario,<br>Cuando selecciona una Fecha "Hasta" que es anterior a la Fecha "Desde",<br>Entonces el sistema resalta los selectores en rojo y muestra el error "Rango de fechas inválido".                                                                                                                                                                                                                                                                                                           | **EP02** |
| **US-04** | Solicitud formal de materiales                                             | Como residente de obra, quiero enviar pedidos de insumos desde la app para evitar errores de comunicación por canales informales.                                                                                        | **Escenario 1 (Éxito):**<br>Dado que el residente requiere materiales,<br>Cuando completa el formulario especificando: Nombre del insumo, Cantidad numérica, Unidad de medida y Fecha máxima,<br>Entonces el sistema genera un ticket de solicitud con código de seguimiento.<br><br>**Escenario 2 (Fallo):**<br>Dado que el residente intenta generar el requerimiento,<br>Cuando deja vacío el input numérico de Cantidad,<br>Entonces el sistema bloquea el botón "Generar Pedido" y exige llenar el campo.                                                                                                                                                                                                                                                                                                                                                        | **EP03** |
| **US-05** | Alerta automática de stock crítico                                         | Como encargado de almacén, quiero recibir notificaciones cuando el inventario sea bajo para evitar paralizar la construcción.                                                                                            | **Escenario 1 (Éxito):**<br>Dado que un material tiene configurado un límite mínimo en su input de configuración,<br>Cuando el stock registrado desciende por debajo de ese límite tras un despacho,<br>Entonces la fila del material se torna roja en la tabla y se activa un ícono de advertencia en el header.<br><br>**Escenario 2 (Alternativo):**<br>Dado que el stock actual está por debajo del límite mínimo,<br>Cuando el cronjob nocturno ejecuta la verificación a las 00:00 hrs,<br>Entonces el sistema envía automáticamente un correo de "Aviso de Reposición" a logística.                                                                                                                                                                                                                                                                            | **EP03** |
| **US-06** | Validación de compra vs presupuesto                                        | Como jefe de compras, quiero que el sistema bloquee pedidos que excedan el presupuesto meta para evitar pérdidas de utilidad.                                                                                            | **Escenario 1 (Fallo/Bloqueo):**<br>Dado que el jefe de compras intenta procesar un pedido que excede el monto presupuestado,<br>Cuando presiona el botón "Confirmar compra",<br>Entonces el sistema despliega un modal de error bloqueando la transacción.<br><br>**Escenario 2 (Éxito):**<br>Dado que el pedido se encuentra dentro del presupuesto disponible,<br>Cuando confirma la transacción,<br>Entonces el botón muestra un spinner de carga, aprueba la compra y descuenta el monto total en la vista.                                                                                                                                                                                                                                                                                                                                                      | **EP03** |
| **US-07** | Visualización de planos por especialidad                                   | Como técnico de obra, quiero filtrar los planos por especialidad para localizar el diseño vigente rápidamente en campo.                                                                                                  | **Escenario 1 (Éxito):**<br>Dado que el técnico visualiza la lista de documentos,<br>Cuando selecciona la option "Instalaciones Eléctricas" en el menú desplegable "Especialidad",<br>Entonces la tabla oculta las filas que no coincidan con la categoría.<br><br>**Escenario 2 (Alternativo/Vacío):**<br>Dado que el técnico aplica un filtro de especialidad,<br>Cuando la base de datos no tiene planos subidos para dicha categoría,<br>Entonces la grilla se vacía y muestra el texto "No se encontraron documentos asociados".                                                                                                                                                                                                                                                                                                                                 | **EP04** |
| **US-08** | Historial de versiones de planos con notificaciones                        | Como arquitecto, quiero ver el registro de versiones de un plano y recibir notificaciones cuando se publique una nueva versión, para asegurar que el equipo no use diseños obsoletos.                                    | **Escenario 1 (Éxito):**<br>Dado que el arquitecto consulta los detalles de un plano,<br>Cuando abre la sección de "Historial",<br>Entonces se lista una tabla con las columnas: N° Versión, Fecha, Responsable y Cambios.<br><br>**Escenario 2 (Fallo en Restauración):**<br>Dado que el arquitecto intenta restaurar una versión anterior,<br>Cuando presiona "Restaurar" y cancela la acción en el modal de confirmación emergente,<br>Entonces el sistema anula el proceso y mantiene el plano actual como vigente.                                                                                                                                                                                                                                                                                                                                               | **EP04** |
| **US-09** | Firma digital de actas con token                                           | Como ingeniero residente, quiero firmar actas de conformidad con un código de verificación para asegurar la validez legal del cierre de etapa.                                                                           | **Escenario 1 (Éxito):**<br>Dado que el residente aprueba la partida,<br>Cuando ingresa el código numérico de 6 dígitos en el input "Token" y presiona "Firmar",<br>Entonces el sistema sella digitalmente el PDF.<br><br>**Escenario 2 (Fallo):**<br>Dado que el residente intenta validar la firma,<br>Cuando ingresa un Token incorrecto o de solo 5 dígitos,<br>Entonces el input se subraya en rojo mostrando "Token inválido" y el acta permanece "Sin firmar".                                                                                                                                                                                                                                                                                                                                                                                                 | **EP02** |
| **US-10** | Landing page - Visualización de propuesta de valor                         | Como profesional del sector construcción que visita el sitio web, quiero conocer la propuesta de valor y funcionalidades principales de Kipu para entender cómo puede ayudarme en mis proyectos de construcción.         | **Escenario 1 (Éxito):**<br>Dado que un visitante accede a la URL pública,<br>Cuando la página carga el Hero Section,<br>Entonces se muestra el título, la propuesta de valor y el botón primario "Registrarse".<br><br>**Escenario 2 (Navegación):**<br>Dado que el visitante desplaza la página hacia abajo,<br>Cuando llega a la sección de características,<br>Entonces se renderizan tarjetas gráficas (Cards) detallando RNC, inventarios y KPIs.                                                                                                                                                                                                                                                                                                                                                                                                               | **EP01** |
| **US-11** | Landing page - Contenido para gestores operativos                          | Como arquitecto o ingeniero que visita el sitio, quiero encontrar información específica sobre cómo Kipu mejora la supervisión técnica y trazabilidad de obra para evaluar si se adapta a mis necesidades profesionales. | **Escenario 1 (Éxito):**<br>Dado que un gestor operativo hace scroll en la landing page,<br>Cuando navega a la vista "Para profesionales de obra",<br>Entonces visualiza contenido específico y el botón "Crear cuenta gratuita".<br><br>**Escenario 2 (Redirección):**<br>Dado que el gestor operativo hace clic en "Crear cuenta gratuita",<br>Cuando el sistema procesa el evento,<br>Entonces lo redirige al formulario de registro con el Radio Button "Gestor Operativo" preseleccionado.                                                                                                                                                                                                                                                                                                                                                                       | **EP01** |
| **US-12** | Landing page - Contenido para equipos de logística                         | Como responsable de logística o administración que visita el sitio, quiero encontrar información específica sobre cómo Kipu centraliza pedidos y controla presupuestos para convencerme de su utilidad en mi área.       | **Escenario 1 (Éxito):**<br>Dado que un profesional de logística lee la sección "Para equipos de logística",<br>Cuando hace clic en el botón "Solicitar demo",<br>Entonces se despliega un formulario exigiendo Nombre, Empresa y Correo.<br><br>**Escenario 2 (Fallo):**<br>Dado que el profesional de logística intenta solicitar la demo,<br>Cuando omite llenar el campo obligatorio "Correo Corporativo" y presiona Enviar,<br>Entonces el botón se deshabilita y pide completar el formulario.                                                                                                                                                                                                                                                                                                                                                                  | **EP01** |
| **US-13** | Atender solicitud de materiales                                            | Como encargado de logística, quiero cambiar el estado de las solicitudes de materiales a "Aprobado" o "Rechazado", para mantener al equipo de obra informado sobre la disponibilidad de los insumos.                     | **Escenario 1 (Éxito):**<br>Dado que existe una solicitud en estado "Pendiente",<br>Cuando el logístico presiona el botón verde "Aprobar",<br>Entonces el estado cambia a "En proceso de compra" en la interfaz del residente.<br><br>**Escenario 2 (Fallo/Rechazo):**<br>Dado que el logístico selecciona el botón "Rechazar",<br>Cuando no redacta nada en el textarea "Motivo del rechazo",<br>Entonces el sistema bloquea la confirmación del cambio de estado.                                                                                                                                                                                                                                                                                                                                                                                                   | **EP03** |
| **US-14** | Actualizar inventario general                                              | Como encargado de logística, quiero actualizar las cantidades de los materiales en el almacén central, para mantener un registro exacto del stock físico disponible para las obras.                                      | **Escenario 1 (Éxito):**<br>Dado que el logístico abre el modal de edición de un material,<br>Cuando ingresa un número mayor a 0 en el input "Cantidad a sumar" y da a Guardar,<br>Entonces el texto del stock actual se recalcula sumando el nuevo valor.<br><br>**Escenario 2 (Fallo):**<br>Dado que el logístico intenta modificar el stock,<br>Cuando digita letras o números negativos en el input de cantidad,<br>Entonces el navegador bloquea la acción y lanza una alerta de "Solo números positivos".                                                                                                                                                                                                                                                                                                                                                       | **EP03** |
| **US-15** | Registrar avance diario de obra                                            | Como residente de obra, quiero registrar el porcentaje de avance físico del proyecto diariamente, para mantener la trazabilidad de la ejecución real frente al cronograma.                                               | **Escenario 1 (Éxito):**<br>Dado que el residente accede al reporte de jornada,<br>Cuando digita un valor de 1 a 100 en el input Avance, selecciona la Fecha y redacta la Observación,<br>Entonces el dashboard actualiza visualmente la barra de progreso.<br><br>**Escenario 2 (Fallo):**<br>Dado que el residente intenta reportar el avance,<br>Cuando ingresa un porcentaje superior a "100",<br>Entonces el sistema subraya el campo en rojo e impide el guardado.                                                                                                                                                                                                                                                                                                                                                                                              | **EP02** |
| **US-16** | Cambiar estado del proyecto                                                | Como administrador del sistema, quiero modificar el estado global de una obra (ej. En ejecución, Paralizada, Finalizada), para reflejar la situación operativa actual ante todos los usuarios.                           | **Escenario 1 (Éxito):**<br>Dado que el administrador accede a la configuración,<br>Cuando elige "Paralizada" en el menú desplegable y llena la "Justificación",<br>Entonces el sistema inactiva los botones de nuevos requerimientos para toda la obra.<br><br>**Escenario 2 (Fallo):**<br>Dado que el administrador selecciona el estado "Paralizada",<br>Cuando intenta guardar sin escribir en el campo "Justificación",<br>Entonces el sistema le impide confirmar el cambio de estado.                                                                                                                                                                                                                                                                                                                                                                          | **EP02** |
| **US-17** | Visualizar Dashboard logístico                                             | Como encargado de logística, quiero visualizar un resumen gráfico de requerimientos pendientes y presupuesto ejecutado, para tomar decisiones de compra rápidas sin tener que cruzar datos de Excel.                     | **Escenario 1 (Éxito):**<br>Dado que el profesional con rol de logística ingresa al sistema,<br>Cuando se carga el Dashboard,<br>Entonces se renderiza un gráfico de anillos comparando solicitudes y una tarjeta del presupuesto ejecutado.<br><br>**Escenario 2 (Alternativo):**<br>Dado que el mes recién inicia y no hay data histórica,<br>Cuando el profesional de logística entra a la vista,<br>Entonces el espacio del gráfico muestra una ilustración y el texto "Sin operaciones registradas".                                                                                                                                                                                                                                                                                                                                                             | **EP03** |
| **US-18** | Asignar roles a usuarios                                                   | Como administrador del sistema, quiero asignar o modificar los permisos de los trabajadores en la plataforma, para asegurar que cada empleado solo tenga acceso a los módulos correspondientes a su cargo.               | **Escenario 1 (Éxito):**<br>Dado que el administrador visualiza la tabla de usuarios,<br>Cuando selecciona "Encargado de Logística" en la columna Rol de un perfil básico,<br>Entonces el sistema le otorga acceso al módulo de Inventario y revoca permisos técnicos.<br><br>**Escenario 2 (Fallo/Auto-bloqueo):**<br>Dado que el administrador intenta editar su propio perfil,<br>Cuando despliega la tabla en su propia fila,<br>Entonces el selector de rol aparece en estado "Disabled" para evitar degradar su propia cuenta.                                                                                                                                                                                                                                                                                                                                  | **EP01** |
| **US-19** | Registro de Consulta Técnica (RFI)                                         | Como residente de obra, quiero generar una RFI dirigida al proyectista para resolver dudas de diseño que impiden el avance de una partida.                                                                               | **Escenario 1 (Éxito):**<br>Dado que el residente detecta una incompatibilidad,<br>Cuando llena la RFI adjuntando un plano y escribiendo la duda en el textarea,<br>Entonces el ticket genera un Label "Abierto" y notifica al proyectista.<br><br>**Escenario 2 (Fallo):**<br>Dado que el arquitecto revisa la RFI para cerrarla,<br>Cuando presiona el botón "Responder" dejando vacía el área de solución técnica,<br>Entonces el sistema lanza un error obligando a escribir la respuesta.                                                                                                                                                                                                                                                                                                                                                                        | **EP04** |
| **US-20** | Exportación de base de datos                                               | Como administrador, quiero exportar la información del proyecto en formatos abiertos (.csv, .json) para garantizar la soberanía de los datos.                                                                            | **Escenario 1 (Éxito):**<br>Dado que el administrador se sitúa en Configuraciones,<br>Cuando selecciona el radio button (.json o .csv) y pulsa "Exportar Data",<br>Entonces el sistema comprime la base de datos y descarga el archivo .zip.<br><br>**Escenario 2 (Fallo de Acceso):**<br>Dado que un residente intenta acceder a la exportación,<br>Cuando ingresa a la URL del endpoint del administrador,<br>Entonces la interfaz lanza una pantalla de Error 403 (Acceso Denegado).                                                                                                                                                                                                                                                                                                                                                                               | **EP05** |
| **US-21** | Control de mermas y desperdicios                                           | Como encargado de almacén, quiero registrar la merma de materiales para ajustar el stock real y analizar la eficiencia de los recursos.                                                                                  | **Escenario 1 (Éxito):**<br>Dado que el almacenero identifica material mermado,<br>Cuando ingresa la cantidad en el input y selecciona "Merma" en el dropdown de salidas,<br>Entonces la cantidad se resta del inventario reportándose como pérdida.<br><br>**Escenario 2 (Fallo/Alerta):**<br>Dado que la merma supera el 5% de tolerancia configurada,<br>Cuando el almacenero pulsa "Registrar",<br>Entonces se guarda, pero el sistema emite un banner naranja advirtiendo el sobrecosto al Gerente.                                                                                                                                                                                                                                                                                                                                                              | **EP03** |
| **US-22** | Reporte fotográfico diario                                                 | Como residente de obra, quiero subir fotos diarias del frente de trabajo para generar una bitácora visual de sustento.                                                                                                   | **Escenario 1 (Éxito):**<br>Dado que el residente finaliza la jornada,<br>Cuando arrastra archivos JPG/PNG al cuadro de carga y asigna checkboxes de "Partida",<br>Entonces las imágenes llenan la galería cronológica del álbum.<br><br>**Escenario 2 (Fallo):**<br>Dado que el residente intenta cargar un archivo de video MP4,<br>Cuando trata de soltarlo en la zona de subida fotográfica,<br>Entonces la interfaz rechaza el archivo y lanza la advertencia "Formato inválido".                                                                                                                                                                                                                                                                                                                                                                                | **EP02** |
| **US-23** | Gestión de subcontratistas                                                 | Como gerente de proyecto, quiero registrar el avance de subcontratistas para controlar sus pagos y cumplimiento de plazos.                                                                                               | **Escenario 1 (Éxito):**<br>Dado que el gerente califica la entrega de un subcontratista,<br>Cuando digita el porcentaje avanzado en la tabla y presiona Enter,<br>Entonces el input de lectura "Monto a pagar" efectúa la multiplicación automática.<br><br>**Escenario 2 (Fallo/Alerta):**<br>Dado que un subcontrato tiene una fecha de vencimiento superada en su Datepicker,<br>Cuando su avance es menor al 100%,<br>Entonces la fila de dicho contratista en la grilla resalta de color rojo por incumplimiento.                                                                                                                                                                                                                                                                                                                                               | **EP02** |
| **US-24** | Registro de incidentes (HSE)                                               | Como supervisor de seguridad, quiero registrar incidentes o condiciones inseguras para cumplir con la normativa de seguridad en el trabajo.                                                                              | **Escenario 1 (Éxito):**<br>Dado que se detecta una condición insegura,<br>Cuando el supervisor elige "Leve" en el menú Gravedad, carga la foto y da a Guardar,<br>Entonces se añade la fila a la tabla de reportes de HSE.<br><br>**Escenario 2 (Alternativo/Bloqueante):**<br>Dado que el supervisor selecciona la gravedad como "Grave",<br>Cuando procesa el formulario,<br>Entonces la partida constructiva en el cronograma se desactiva y muestra un ícono de candado cerrado.                                                                                                                                                                                                                                                                                                                                                                                 | **EP06** |
| **US-25** | Acceso de visualización para Cliente                                       | Como cliente de la obra, quiero tener acceso de solo lectura para monitorear el avance físico y financiero de mi inversión.                                                                                              | **Escenario 1 (Éxito):**<br>Dado que el cliente usa el login con su perfil asignado,<br>Cuando accede a su interfaz,<br>Entonces el DOM oculta absolutamente todos los botones de "Crear", "Editar" y "Eliminar".<br><br>**Escenario 2 (Fallo/Acción Restringida):**<br>Dado que el cliente visualiza el diagrama de barras del cronograma,<br>Cuando intenta arrastrar con el mouse un nodo para cambiar fechas,<br>Entonces la gráfica ignora el evento de arrastre (drag\&drop) demostrando la restricción.                                                                                                                                                                                                                                                                                                                                                        | **EP02** |
| **US-26** | Alerta de desviación presupuestal                                          | Como jefe de oficina técnica, quiero recibir notificaciones si el gasto real supera el presupuesto meta para tomar medidas correctivas.                                                                                  | **Escenario 1 (Éxito/Alerta):**<br>Dado que se cierra una transacción en Logística,<br>Cuando el input del "Precio de compra" sobrepasa el precio base unitario en la BD,<br>Entonces se emite un Toast automático advirtiendo "Sobrecosto en partida".<br><br>**Escenario 2 (Fallo/Desviación Crítica):**<br>Dado que el gerente consulta la tabla general de presupuesto,<br>Cuando el sistema calcula una varianza superior al 10% en una celda,<br>Entonces el fondo de esa celda se pinta en rojo sangre para captar la atención del técnico.                                                                                                                                                                                                                                                                                                                    | **EP02** |
| **US-27** | Préstamo de herramientas                                                   | Como encargado de almacén, quiero controlar el préstamo de equipos a las cuadrillas para evitar pérdidas y gestionar el mantenimiento.                                                                                   | **Escenario 1 (Éxito):**<br>Dado que un operario requiere un equipo menor,<br>Cuando el almacenero busca el DNI en el buscador y asocia la herramienta,<br>Entonces el badge de la herramienta cambia visualmente a "En Uso".<br><br>**Escenario 2 (Fallo):**<br>Dado que se registra el retorno del equipo,<br>Cuando el almacenero selecciona el radio button "Devuelto con Daños" y no escribe justificación,<br>Entonces el botón de guardado no se habilita exigiendo detalles en el textarea.                                                                                                                                                                                                                                                                                                                                                                   | **EP03** |
| **US-28** | Activación de Plugins                                                      | Como desarrollador, quiero habilitar módulos adicionales mediante la API de Kipu para extender las funciones básicas del sistema.                                                                                        | **Escenario 1 (Éxito):**<br>Dado que el administrador cuenta con un plugin compatible,<br>Cuando carga el archivo `.zip` en el input file y pulsa "Instalar",<br>Entonces el núcleo lo procesa y despliega una nueva sección funcional en el Sidebar.<br><br>**Escenario 2 (Fallo):**<br>Dado que el `.zip` cargado no cumple con la firma técnica del software,<br>Cuando pulsa "Instalar",<br>Entonces el sistema arroja un Modal Error con el trace log, denegando la instalación.                                                                                                                                                                                                                                                                                                                                                                                 | **EP05** |
| **US-29** | Anotaciones digitales sobre planos                                         | Como residente de obra, quiero realizar anotaciones digitales sobre el plano de cimentación, para reportar interferencias detectadas en campo inmediatamente al equipo de diseño.                                        | **Escenario 1 (Éxito):**<br>Dado que el residente inspecciona el visor PDF del plano,<br>Cuando hace clic en el canvas, escribe el texto en el globo emergente y guarda,<br>Entonces se posiciona un marcador visual (Pin) sobre esa coordenada específica.<br><br>**Escenario 2 (Fallo):**<br>Dado que el residente hace clic en el plano para reportar,<br>Cuando presiona "Enviar anotación" con la caja de texto completamente vacía,<br>Entonces el contorno del cuadro de texto se vuelve rojo, impidiendo la creación del pin.                                                                                                                                                                                                                                                                                                                                 | **EP04** |
| **US-30** | Generación de dossier de calidad                                           | Como gerente de proyecto, quiero exportar un archivo PDF con todo el historial de firmas, RNCs y aprobaciones de una etapa, para facilitar la entrega del proyecto a la municipalidad o al cliente final.                | **Escenario 1 (Éxito):**<br>Dado que el proyecto ha concluido la etapa,<br>Cuando el gerente selecciona los checkboxes de los documentos a incluir y presiona "Construir Dossier",<br>Entonces se descarga un PDF consolidado con índice y Código QR de verificación.<br><br>**Escenario 2 (Fallo):**<br>Dado que el gerente presiona "Construir Dossier",<br>Cuando no ha seleccionado ningún checkbox de la lista inferior,<br>Entonces la acción rebota mostrando un Tooltip "Debe marcar al menos 1 documento".                                                                                                                                                                                                                                                                                                                                                   | **EP04** |
| **US-31** | Registro de desperdicios y devoluciones                                    | Como encargado de almacén, quiero registrar la cantidad de material dañado o sobrante por cada jornada, para ajustar las futuras compras y reducir el desperdicio acumulado.                                             | **Escenario 1 (Éxito):**<br>Dado que existe material sobrante reutilizable,<br>Cuando el almacenero selecciona "Devolución a proveedor" en el menú desplegable y guarda,<br>Entonces el sistema descuenta el material y renderiza una nota de crédito a favor.<br><br>**Escenario 2 (Fallo):**<br>Dado que el almacenero intenta registrar un "Desperdicio",<br>Cuando deja la cantidad del desperdicio en blanco o igual a 0,<br>Entonces el formulario marca el error e impide registrar un volumen irreal.                                                                                                                                                                                                                                                                                                                                                         | **EP03** |
| **US-32** | Control de entrega de Equipo de seguridad al personal                      | Como supervisor de obras, quiero registrar la entrega de cascos y botas a cada trabajador para tener un respaldo ante auditorías laborales.                                                                              | **Escenario 1 (Éxito):**<br>Dado que el supervisor entrega botas nuevas,<br>Cuando usa la barra de búsqueda para hallar al obrero y selecciona el ítem "Botas",<br>Entonces se descuenta 1 unidad del inventario y figura la asignación en la tabla del personal.<br><br>**Escenario 2 (Alerta):**<br>Dado que el sistema coteja las fechas de vida útil de los equipos,<br>Cuando la fecha actual excede la fecha de caducidad del Datepicker asociado al arnés de un obrero,<br>Entonces se muestra una etiqueta amarilla "Vencido" junto al nombre del empleado.                                                                                                                                                                                                                                                                                                   | **EP06** |
| **US-33** | Dashboard de cumplimiento de las normas de Seguridad y Salud en el Trabajo | Como supervisor de obras, quiero ver un gráfico de barras con el número de incidentes vs. días sin accidentes para medir la seguridad de la empresa.                                                                     | **Escenario 1 (Éxito):**<br>Dado que el supervisor accede a la vista principal HSE,<br>Cuando el panel carga,<br>Entonces el sistema muestra una tarjeta gigante resaltada en color verde con los "Días sin Accidentes".<br><br>**Escenario 2 (Fallo/Reinicio):**<br>Dado que hoy se registró un RNC de Nivel "Grave",<br>Cuando el dashboard vuelve a renderizarse,<br>Entonces la tarjeta principal borra su acumulado y regresa al número "0" automáticamente.                                                                                                                                                                                                                                                                                                                                                                                                     | **EP06** |
| **US-34** | Bitácora fotográfica de excavaciones                                       | Como supervisor de obras, quiero crear una galería específica para la etapa de excavación para documentar el tipo de suelo encontrado y evitar reclamos futuros.                                                         | **Escenario 1 (Éxito):**<br>Dado que el operario toma fotos del terreno,<br>Cuando las sube activando el checkbox "Suelo/Excavación",<br>Entonces la UI filtra y aísla esas imágenes en una carpeta apartada del álbum general.<br><br>**Escenario 2 (Fallo):**<br>Dado que el cliente solicita el reporte fotográfico de suelos,<br>Cuando el supervisor presiona el botón "Descargar Evidencia" y la carpeta de excavación está vacía,<br>Entonces se dispara una alerta indicando "No existen fotos etiquetadas para esta partida".                                                                                                                                                                                                                                                                                                                                | **EP02** |
| **US-35** | Seguimiento de órdenes de cambio                                           | Como gerente de proyecto, quiero registrar modificaciones al contrato original solicitadas por el cliente para ajustar el presupuesto y cronograma oficial.                                                              | **Escenario 1 (Éxito):**<br>Dado que el cliente exige agregar un nivel extra,<br>Cuando el gerente añade las nuevas filas presupuestales en la "Orden de Cambio",<br>Entonces una tarjeta inferior totalizadora refleja en vivo el impacto monetario adicional.<br><br>**Escenario 2 (Fallo en Fechas):**<br>Dado que el gerente actualiza los plazos por la orden de cambio,<br>Cuando ingresa una fecha de inicio de la nueva partida superior a la fecha de fin de obra general,<br>Entonces el Datepicker marca error de lógica de fechas impidiendo guardar.                                                                                                                                                                                                                                                                                                     | **EP02** |
| **US-36** | Control de herramientas asignadas                                          | Como encargado de almacén, quiero registrar las herramientas eléctricas asignadas (taladros, amoladoras) a un obrero específico para que sea el responsable de su devolución en buen estado.                             | **Escenario 1 (Éxito):**<br>Dado que se va a asignar una amoladora mediante su código serie,<br>Cuando el logístico la vincula al código del operario y pulsa Confirmar,<br>Entonces el estatus del equipo en la grilla cambia de "Disponible" a "Asignado".<br><br>**Escenario 2 (Fallo):**<br>Dado que el logístico intenta asignar la amoladora,<br>Cuando escanea o digita el código de un trabajador inactivo o no existente en la BD,<br>Entonces el input de búsqueda no le permite avanzar y muestra "Operario no hallado".                                                                                                                                                                                                                                                                                                                                   | **EP03** |
| **US-37** | Exportación de reporte de asistencia mensual                               | Como supervisor de obra, quiero exportar las asistencias del mes a un archivo CSV para facilitar el cálculo de la planilla en el software contable.                                                                      | **Escenario 1 (Éxito):**<br>Dado que culminó la quincena,<br>Cuando el supervisor pulsa el botón "Exportar Asistencias" eligiendo formato CSV,<br>Entonces el navegador descarga la plantilla limpia y formateada para el sistema contable.<br><br>**Escenario 2 (Alternativo):**<br>Dado que el supervisor solo necesita la data de una de sus 3 obras,<br>Cuando aplica el filtro "Edificio Sol" en el Menú de Proyectos antes de descargar,<br>Entonces el CSV compilado filtra y excluye a cualquier operario ajeno a ese edificio.                                                                                                                                                                                                                                                                                                                               | **EP06** |
| **US-38** | Visualización de planos en 3D                                              | Como arquitecto o residente de obra, quiero visualizar modelos 3D sencillos (formatos glTF/OBJ) para realizar implementaciones extra de manera efectiva.                                                                 | **Escenario 1 (Éxito):**<br>Dado que se carga un diseño de tuberías 3D en formato `.glTF`,<br>Cuando el arquitecto sube el archivo al 100%,<br>Entonces el canvas WebGL renderiza la estructura permitiendo hacer zoom y paneo con el mouse.<br><br>**Escenario 2 (Fallo):**<br>Dado que el arquitecto arrastra un archivo genérico CAD (`.dwg`),<br>Cuando lo suelta sobre la zona de Dropeo 3D,<br>Entonces el recuadro detecta la extensión y lo bota con el mensaje "Formato no permitido (Solo OBJ/GLTF)".                                                                                                                                                                                                                                                                                                                                                       | **EP04** |
| **US-39** | Gestión de residuos de construcción                                        | Como encargado ambiental o de obra, quiero registrar el volumen de residuos retirados de la obra para cumplir con la normativa ambiental municipal.                                                                      | **Escenario 1 (Éxito):**<br>Dado que un camión se lleva el desmonte,<br>Cuando el responsable escribe los Metros Cúbicos en el input y da a "Añadir viaje",<br>Entonces la barra general de cumplimiento ambiental suma el volumen descartado.<br><br>**Escenario 2 (Fallo/Bloqueo):**<br>Dado que se intenta crear el ticket de retiro,<br>Cuando el responsable no digita la Placa del Vehículo transportista (obligatoria por ley municipal),<br>Entonces el botón de registro permanece inactivo pidiendo completar el campo.                                                                                                                                                                                                                                                                                                                                     | **EP06** |
| **US-40** | Registro de mantenimiento de maquinaria                                    | Como encargado de almacén/equipos, quiero programar alertas de mantenimiento para las mezcladoras según horas de uso para evitar paradas por avería.                                                                     | **Escenario 1 (Éxito):**<br>Dado que el horómetro virtual de la mezcladora alcanza el input límite de "500 hrs",<br>Cuando el sistema evalúa la máquina,<br>Entonces dispara un ícono de exclamación al lado del ítem exigiendo revisión técnica al encargado.<br><br>**Escenario 2 (Fallo):**<br>Dado que el técnico intenta resetear el horómetro,<br>Cuando presiona "Mantenimiento Completado" sin adjuntar el voucher PDF de servicio,<br>Entonces el sistema rechaza la solicitud pidiendo la validación formal obligatoria.                                                                                                                                                                                                                                                                                                                                    | **EP06** |
| **US-41** | Registro de capacitación en obra                                           | Como supervisor de obra, quiero registrar las charlas técnicas impartidas al personal, para cumplir con el currículum de capacitación exigido por la normativa de construcción.                                          | **Escenario 1 (Éxito):**<br>Dado que la charla de 5 minutos acaba,<br>Cuando el supervisor tilda los checkboxes de asistencia junto a los nombres de la cuadrilla,<br>Entonces el perfil individual de cada operario suma la charla a su registro.<br><br>**Escenario 2 (Alerta Preventiva):**<br>Dado que se revisa el perfil de un ayudante recién contratado,<br>Cuando el sistema detecta que el Checkbox "Charla Inductiva Básica" está vacío,<br>Entonces renderiza una franja roja que prohíbe su asignación a labores peligrosas.                                                                                                                                                                                                                                                                                                                             | **EP06** |
| **US-42** | Monitoreo de temperatura y humedad para curado de concreto (IoT)           | Como residente de obra, quiero recibir alertas automáticas cuando las condiciones ambientales no sean óptimas para el curado del concreto, para evitar fisuras y garantizar la calidad estructural.                      | **Escenario 1 (Éxito/Alerta):**<br>Dado que el gateway MQTT recibe el JSON del sensor termopar,<br>Cuando la propiedad `temperatura` excede el input configurado como 35°C en la vista,<br>Entonces el sistema notifica una alerta push inmediata de peligro en el curado al residente.<br><br>**Escenario 2 (Fallo de conexión IoT):**<br>Dado que el sensor físico se apaga o pierde conectividad,<br>Cuando el sistema no recibe payloads MQTT en un lapso mayor a 1 hora,<br>Entonces el estatus del sensor en el dashboard cambia de "En Línea" a "Offline (Rojo)".                                                                                                                                                                                                                                                                                              | **EP07** |
| **US-43** | Monitoreo de vibraciones en edificios colindantes (IoT)                    | Como supervisor de seguridad, quiero recibir alertas en tiempo real cuando los sensores de vibración detecten movimientos peligrosos durante excavaciones, para evitar daños estructurales a propiedades vecinas.        | **Escenario 1 (Éxito/Bloqueo):**<br>Dado que el payload entrante de vibración arroja `7 mm/s`,<br>Cuando el backend compara con el umbral seguro de `5 mm/s`,<br>Entonces la pantalla del módulo de excavación se bloquea con un modal estricto de "Riesgo Sísmico".<br><br>**Escenario 2 (Liberación):**<br>Dado que la alerta bloquea las operaciones lógicas,<br>Cuando el supervisor revisa el campo, ingresa su contraseña y pulsa "Reanudar Actividad",<br>Entonces el modal se cierra y el log registra que autorizó el reinicio bajo su riesgo.                                                                                                                                                                                                                                                                                                               | **EP07** |
| **US-44** | Sensor de nivel de materiales en tolvas (IoT)                              | Como encargado de almacén, quiero recibir alertas automáticas cuando el nivel de agregados (arena, piedra) en las tolvas esté por debajo del mínimo, para solicitar reabastecimiento antes de que se agote.              | **Escenario 1 (Éxito/Ticket automático):**<br>Dado que la lectura del sensor láser indica `nivel: 12%`,<br>Cuando la plataforma evalúa que es inferior al 15% del límite configurado,<br>Entonces Kipu auto-genera y deposita en la bandeja logística un ticket de "Reabastecer Arena".<br><br>**Escenario 2 (Recarga automática):**<br>Dado que un camión vierte la arena y el sensor lee un salto al `80%`,<br>Cuando procesa el JSON,<br>Entonces la barra de stock en el módulo inventario sube sin que el encargado de almacén haya tecleado el ingreso.                                                                                                                                                                                                                                                                                                         | **EP07** |
| **US-45** | Geolocalización de equipos de alto valor (IoT)                             | Como encargado de almacén, quiero rastrear la ubicación de equipos de alto valor (vibrador de concreto, estación total) mediante sensores GPS, para prevenir robos y optimizar su asignación en obra.                    | **Escenario 1 (Éxito):**<br>Dado que el GPS del teodolito emite telemetría constante,<br>Cuando el encargado ingresa a la vista de "Rastreo",<br>Entonces visualiza un mapa con un Pin dinámico desplazándose en vivo según la latitud y longitud.<br><br>**Escenario 2 (Fallo/Geocerca):**<br>Dado que el administrador dibujó en el visor un polígono "Límite de la Obra",<br>Cuando la coordenada entrante del GPS cae fuera de las fronteras de dicho polígono,<br>Entonces suena un Beep ininterrumpido en la web y envía SMS urgente alertando el robo/salida al encargado.                                                                                                                                                                                                                                                                                     | **EP07** |
