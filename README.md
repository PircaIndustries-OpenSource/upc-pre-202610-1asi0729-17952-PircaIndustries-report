...
| **US-10** | Landing page informativa | Como visitante del sitio web, quiero conocer las características y beneficios de Kipu para decidir si solicito una demostración o me registro. | **Escenario 1:** <br>Dado que un visitante accede al landing page de Kipu, <br>Cuando navega por las secciones de características, beneficios y precios, <br>Entonces el sitio muestra información clara sobre la plataforma y un botón de llamado a la acción (registro / demo). <br><br>**Escenario 2:** <br>Dado que el visitante pertenece al segmento de gestores operativos, <br>Cuando hace clic en el botón "Comenzar" o "Solicitar demo", <br>Entonces es redirigido al formulario de registro o contacto según corresponda en la web application. | **EP01** |
