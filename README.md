...
| **EP02** | Gestión de calidad y trazabilidad (RNC y KPIs) | Como gestor operativo, quiero registrar y verificar la calidad de cada proceso de obra para reducir los Resultados No Conformes y medir la productividad. | **Escenario 1:** Registro de RNC <br>Dado que el supervisor detecta una falla técnica, <br>Cuando completa el formulario de incidencia con fotos, <br>Entonces el sistema genera un ticket de trazabilidad y notifica al equipo de diseño. <br><br>**Escenario 2:** Cálculo de PPC <br>Dado que el equipo cierra las tareas del día, <br>Cuando el gerente accede al módulo de indicadores, <br>Entonces el sistema calcula automáticamente el Porcentaje de Plan Completado semanal. <br><br>**Escenario 3:** Firma digital con token <br>Dado que el residente verifica una partida conforme, <br>Cuando ingresa el código de verificación enviado a su celular, <br>Entonces el sistema sella digitalmente el acta como aprobada. |
...
| **EP04** | Visualización técnica y gestión de planos | Como profesional técnico, quiero acceder a planos actualizados y documentación técnica desde cualquier lugar para evitar errores de construcción por diseños obsoletos. | **Escenario 1:** Filtro de planos por especialidad <br>Dado que el técnico visualiza la lista de documentos, <br>Cuando selecciona el filtro de especialidad requerida, <br>Entonces la aplicación muestra únicamente los planos de esa categoría. <br><br>**Escenario 2:** Historial de versiones <br>Dado que el arquitecto consulta un plano, <br>Cuando abre la sección de historial, <br>Entonces el sistema lista todas las versiones previas con fecha y responsable. <br><br>**Escenario 3:** Restauración de versiones anteriores <br>Dado que el arquitecto necesita recuperar un diseño previo, <br>Cuando selecciona una versión antigua y confirma la restauración, <br>Entonces el sistema actualiza el plano vigente y registra el cambio en el historial. |
| **EP05** | Supervisión Ejecutiva y Reportes | Como interesado del proyecto, quiero visualizar dashboards automáticos para monitorear el progreso real frente al planificado. | **Escenario 1:** Dashboard financiero con métricas de desviación y gasto real. <br>**Escenario 2:** Acceso de "Solo Lectura" para clientes con visualización de fotos y avance físico. <br>**Escenario 3:** Reportes semanales automáticos integrando bitácora y KPIs. |
| **EP06** | Administración, Soberanía y Extensibilidad | Como administrador o desarrollador, quiero gestionar la infraestructura y escalar el sistema mediante código abierto. | **Escenario 1:** Exportación total de datos en formatos abiertos (.csv, .json) para respaldo. <br>**Escenario 2:** Integración de plugins externos mediante API para nuevas funcionalidades. <br>**Escenario 3:** Logs de auditoría de sistema para rastrear cambios en la configuración base. |
| **EP07** | Gestión de documentación y anotaciones técnicas | Como profesional técnico, quiero documentar observaciones y generar reportes de calidad directamente desde la plataforma para mantener un registro histórico completo del proyecto. | **Escenario 1:** Anotaciones digitales sobre planos <br>Dado que el residente detecta una interferencia en campo, <br>Cuando selecciona un área del plano y agrega una anotación, <br>Entonces el sistema guarda la observación y notifica al equipo de diseño. <br><br>**Escenario 2:** Generación de dossier de calidad <br>Dado que el proyecto está en etapa de cierre, <br>Cuando el gerente solicita la exportación del dossier, <br>Entonces el sistema genera un PDF con todo el historial de RNCs, firmas y aprobaciones. <br><br>**Escenario 3:** Registro de desperdicios <br>Dado que se identifica material dañado en obra, <br>Cuando el encargado registra la cantidad con el motivo "Merma" o "Devolución", <br>Entonces el sistema descuenta del stock y lo reporta en el dashboard financiero. |
| **EP08** | **Seguridad, Salud y Cumplimiento** | Como supervisor de obra, quiero gestionar los permisos y equipos de protección para asegurar un entorno de trabajo bajo norma. | **Escenario 1: Control de EPP** <br>Dado que un trabajador ingresa a una zona de riesgo, <br>Cuando el sistema verifica su entrega de equipo de protección, <br>Entonces emite una alerta si el equipo está vencido o no ha sido entregado. <br><br>**Escenario 2: Validación de Permisos de Alto Riesgo** <br>Dado que se requiere realizar una tarea peligrosa (excavación o altura), <br>Cuando el supervisor intenta iniciar la actividad sin un PETAR aprobado, <br>Entonces el sistema bloquea el registro de avance y exige la carga del permiso firmado. |
...
| **US-13** | Subir nueva versión de plano | Como Residente de Obra, quiero subir una nueva versión actualizada de un plano técnico, para asegurar que el equipo en campo construya basándose en el diseño final aprobado. | **Escenario 1:** <br>Dado que la sección de expedientes del proyecto está abierta, <br>Cuando se adjunta un archivo PDF válido y se confirma la subida, <br>Entonces el sistema etiqueta el nuevo documento como "Versión Actual", y archiva automáticamente el documento anterior en el historial. <br><br>**Escenario 2:** <br>Dado que la sección de expedientes está abierta, <br>Cuando se intenta subir un archivo con extensión no permitida (ej. .exe o .mp4), <br>Entonces el sistema muestra un mensaje de error de formato y cancela el proceso de subida de versión. | **EP04** |
| **US-14** | Consultar historial de planos | Como Residente de Obra, quiero visualizar el historial completo de versiones de un plano, para auditar los cambios realizados por el área de diseño a lo largo del tiempo. | **Escenario 1:** <br>Dado que existe un plano con múltiples versiones cargadas, <br>Cuando se selecciona la opción "Ver historial", <br>Entonces se despliega una lista ordenada cronológicamente con todas las versiones, y se habilita la opción de descargar cada versión anterior. | **EP04** |
| **US-15** | Generar requerimiento de materiales | Como Residente de Obra, quiero crear una solicitud formal de materiales desde la plataforma, para que el equipo de logística proceda con las compras sin utilizar canales informales. | **Escenario 1:** <br>Dado que el formulario de requerimiento de materiales está disponible, <br>Cuando se completan los campos obligatorios (material, cantidad, fecha límite) y se envía, <br>Entonces el sistema registra la solicitud con estado "Pendiente", y emite una notificación al Encargado de Logística. <br><br>**Escenario 2:** <br>Dado que el formulario de requerimiento de materiales está abierto, <br>Cuando se envía el formulario omitiendo la cantidad requerida, <br>Entonces el sistema resalta el campo en rojo y muestra una alerta indicando que los campos obligatorios deben completarse. | **EP03** |
